(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[59668, 75514, 70077, 45953, 27763, 20708, 77639, 92107], {
    650151: (t, e) => {
        "use strict";
        function n(t, e) {
            if (void 0 === t)
    ...
    960521: function(t, e, n) {
        ...
        !function() {
            "use strict";
            var i, o = 1e6, s = 1e6, a = "[big.js] ", u = a + "Invalid ", l = u + "decimal places", c = u + "rounding mode", f = a + "Division by zero", h = {}, d = void 0, p = /^-?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
            function v(t, e, n, r) {
                var i = t.c;
                if (n === d && (n = t.constructor.RM),
                0 !== n && 1 !== n && 2 !== n && 3 !== n)
                    throw Error(c);
                if (e < 1)
                    r = 3 === n && (r || !!i[0]) || 0 === e && (1 === n && i[0] >= 5 || 2 === n && (i[0] > 5 || 5 === i[0] && (r || i[1] !== d))),
                    i.length = 1,
                    r ? (t.e = t.e - e + 1,
                    i[0] = 1) : i[0] = t.e = 0;
                else if (e < i.length) {
                    if (r = 1 === n && i[e] >= 5 || 2 === n && (i[e] > 5 || 5 === i[e] && (r || i[e + 1] !== d || 1 & i[e - 1])) || 3 === n && (r || !!i[0]),
                    i.length = e--,
                    r)
                        for (; ++i[e] > 9; )
                            i[e] = 0,
            ...
            h.div = function(t) {
                ...
                if (!r[0])
                    ...
                    t.c = [t.e = 0],
                    t;
                var u, c, h, p, g, m = i.slice(), y = u = i.length, _ = r.length, b = r.slice(0, u), w = b.length, x = t, E = x.c = [], C = 0, k = a + (x.e = e.e - t.e) + 1;
                for (x.s = s,
                s = k < 0 ? 0 : k,
                m.unshift(0); w++ < u; )
                    b.push(0);
                do {
                    ...
                    E[C++] = p ? h : ++h,
                    b[0] && p ? b[w] = r[y] || 0 : b = [r[y]]
                } while ((y++ < _ || b[0] !== d) && s--);
                return E[0] || 1 == C || (E.shift(),
                x.e--,
                k--),
                C > k && v(x, k, n.RM, b[0] !== d),
                x
            }
            ,
            h.eq = function(t) {
            ...
            h.minus = h.sub = function(t) {
                ...
                var l = o.c.slice()
                  ...
                  , h = t.e;
                if (!l[0] || !f[0])
                    return f[0] ? t.s = -u : l[0] ? t = new s(o) : t.s = 1,
                    t;
                if (a = c - h) {
                    for ((i = a < 0) ? (a = -a,
                    r = l) : (h = c,
                    ...
                    for (n = ((i = l.length < f.length) ? l : f).length,
                    a = u = 0; u < n; u++)
                        if (l[u] != f[u]) {
                            i = l[u] < f[u];
                            break
            ...
            h.plus = h.add = function(t) {
                ...
                var s = i.e
                  ...
                  , l = t.c;
                if (!a[0] || !l[0])
                    return l[0] || (a[0] ? t = new o(i) : t.s = i.s),
                    t;
                if (a = a.slice(),
                e = s - u) {
                    for (e > 0 ? (u = s,
                ...
                for (a.length - l.length < 0 && (r = l,
                l = a,
                a = r),
                e = l.length,
                n = 0; e; a[e] %= 10)
                    n = (a[--e] = a[e] + l[e] + n) / 10 | 0;
                for (n && (a.unshift(n),
                ++u),
                e = a.length; 0 === a[--e]; )
                    a.pop();
            ...
            h.times = h.mul = function(t) {
                var e, n = this, r = n.constructor, i = n.c, o = (t = new r(t)).c, s = i.length, a = o.length, u = n.e, l = t.e;
                if (t.s = n.s == t.s ? 1 : -1,
                !i[0] || !o[0])
                    return t.c = [t.e = 0],
                    t;
        ...
        n = function(t) {
            ...
            var i = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform)
              ...
              , f = function(t) {
                ...
                return !!c(e.target) || 1 < e.touches.length || (e.preventDefault && e.preventDefault(),
                !1)
            }
              , h = function() {
                setTimeout((function() {
                ...
                if (i) {
                    ...
                    if (t && !o.some((function(e) {
                        ...
                        t.ontouchmove = function(e) {
                            ...
                            !c(n.target) && (r && 0 === r.scrollTop && 0 < o || (i = r) && i.scrollHeight - i.scrollTop <= i.clientHeight && o < 0 ? f(n) : n.stopPropagation()))
                        }
                        ,
            ...
            t.enableBodyScroll = function(t) {
                if (i) {
                    ...
                    1 === o.length && o[0].targetElement === t ? (h(),
        ...
        void 0 === (o = "function" == typeof (r = function(t) {
            ...
            function(t, e) {
                ...
                function d(e) {
                    ...
                    f(o, (function(t, n) {
                        var o, s = n.re.exec(e), u = s && n.parse(s), l = n.space || "rgba";
                        if (u)
                            return o = r[l](u),
                            r[a[l].cache] = o[a[l].cache],
                            i = r._rgba = o._rgba,
                            !1
                    }
                    )),
                ...
                s.fn = t.extend(s.prototype, {
                    parse: function(r, i, o, u) {
                        ...
                        c = "array"),
                        "string" === c ? this.parse(d(r) || n._default) : "array" === c ? (f(a.rgba.props, (function(t, e) {
                            p[e.idx] = h(r[e.idx], e)
                        }
                        )),
                        this) : "object" === c ? (f(a, r instanceof s ? function(t, e) {
                            r[e.cache] && (l[e.cache] = r[e.cache].slice())
                        }
                        : function(e, n) {
                            var i = n.cache;
                            ...
                            l[i] && t.inArray(null, l[i].slice(0, 3)) < 0 && (l[i][3] = 1,
                            n.from && (l._rgba = n.from(l[i])))
                        }
                        ),
                        this) : void 0
                    },
                    ...
                    transition: function(t, e) {
                        ...
                        f(i.props, (function(t, r) {
                            var i = r.idx
                              ...
                              , s = n[i]
                              , a = u[r.type] || {};
                            null !== s && (null === o ? c[i] = s : (a.mod && (s - o > a.mod / 2 ? o += a.mod : o - s > a.mod / 2 && (o -= a.mod)),
                            c[i] = h((s - o) * e + o, r)))
                        }
                        )),
                        this[r](c)
                ...
                a.hsla.to = function(t) {
                    ...
                    var e, n, r = t[0] / 255, i = t[1] / 255, o = t[2] / 255, s = t[3], a = Math.max(r, i, o), u = Math.min(r, i, o), l = a - u, c = a + u, f = .5 * c;
                    return e = u === a ? 0 : r === a ? 60 * (i - o) / l + 360 : i === a ? 60 * (o - r) / l + 120 : 60 * (r - i) / l + 240,
                    n = 0 === l ? 0 : f <= .5 ? l / c : l / (2 - c),
                ...
                f(a, (function(n, r) {
                    ...
                    s.fn[n] = function(n) {
                        ...
                        n === e)
                            return this[a].slice();
                        var r, i = t.type(n), c = "array" === i || "object" === i ? n : arguments, d = this[a].slice();
                        return f(o, (function(t, e) {
                            var n = c["object" === i ? t : e.idx];
                            null == n && (n = d[e.idx]),
                            d[e.idx] = h(n, e)
                        }
                        )),
                    ...
                    f(o, (function(e, r) {
                        s.fn[e] || (s.fn[e] = function(o) {
                            var s, a = t.type(o), u = "alpha" === e ? this._hsla ? "hsla" : "rgba" : n, l = this[u](), c = l[r.idx];
                            return "undefined" === a ? c : ("function" === a && (o = o.call(this, c),
                            a = t.type(o)),
                            null == o && r.empty ? this : ("string" === a && (s = i.exec(o)) && (o = c + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1)),
                            l[r.idx] = o,
                            this[u](l)))
                        }
                        )
                ...
                s.hook = function(e) {
                    ...
                    f(n, (function(e, n) {
                        t.cssHooks[n] = {
                            set: function(e, r) {
                                var i, o, a = "";
                                if ("transparent" !== r && ("string" !== t.type(r) || (i = d(r)))) {
                                    if (r = s(i || r),
                                    !l.rgba && 1 !== r._rgba[3]) {
            ...
            function() {
                ...
                t.effects.animateClass = function(e, r, o, a) {
                    ...
                    return this.queue((function() {
                        var r, o = t(this), a = o.attr("class") || "", l = u.children ? o.find("*").addBack() : o;
                        l = l.map((function() {
                            return {
                                el: t(this),
                                start: i(this)
            ...
            function() {
                ...
                t.fn.extend({
                    effect: function() {
                        ...
                        if (t.fx.off || !n)
                            return l ? this[l](e.duration, u) : this.each((function() {
                                u && u.call(this)
                            }
                            ));
                        function h(o) {
                            ...
                            e.mode = c.shift(),
                            !1 === t.uiBackCompat || r ? "none" === e.mode ? (s[l](),
                            f()) : n.call(s[0], e, a) : (s.is(":hidden") ? "hide" === l : "show" === l) ? (s[l](),
                            f()) : n.call(s[0], e, f)
                        }
                        return !1 === s ? this.each(f).each(h) : this.queue(a, f).queue(a, h)
                    },
                    show: function(t) {
                        return function(e) {
                            if (s(e))
    ...
    162066: (t, e, n) => {
        ...
        void 0 === (o = "function" == typeof (r = function(t) {
            ...
            t.widget = function(e, n, r) {
                var i, o, s, a = {}, u = e.split(".")[0], l = u + "-" + (e = e.split(".")[1]);
                return r || (r = n,
                n = t.Widget),
        ...
        void 0 === (o = "function" == typeof (r = function(t) {
            return t.widget("ui.slider", t.ui.mouse, {
                ...
                _mouseCapture: function(e) {
                    var n, r, i, o, s, a, u, l = this, c = this.options;
                    ...
                    this.handles.each((function(e) {
                        var n = Math.abs(r - l.values(e));
                        (i > n || i === n && (e === l._lastChangedValue || l.values(e) === c.min)) && (i = n,
                        o = t(this),
                        s = e)
                    }
                    )),
                ...
                _refreshValue: function() {
                    var e, n, r, i, o, s = this.options.range, a = this.options, u = this, l = !this._animateOff && a.animate, c = {};
                    this._hasMultipleValues() ? this.handles.each((function(r) {
                        n = (u.values(r) - u._valueMin()) / (u._valueMax() - u._valueMin()) * 100,
                        c["horizontal" === u.orientation ? "left" : "bottom"] = n + "%",
                        t(this).stop(1, 1)[l ? "animate" : "css"](c, a.animate),
                        !0 === u.options.range && ("horizontal" === u.orientation ? (0 === r && u.range.stop(1, 1)[l ? "animate" : "css"]({
                            left: n + "%"
                        }, a.animate),
                        1 === r && u.range[l ? "animate" : "css"]({
                            width: n - e + "%"
                        }, {
                            queue: !1,
                            duration: a.animate
                        })) : (0 === r && u.range.stop(1, 1)[l ? "animate" : "css"]({
                            bottom: n + "%"
                        }, a.animate),
                        1 === r && u.range[l ? "animate" : "css"]({
                            height: n - e + "%"
        ...
        o = function(t) {
            ...
            m.prototype.parse = function(e, r) {
                ...
                return null == s && (s = o[e] = function(e, r) {
                    ...
                    w(r || t.tags);
                    for (var x, E, C, k, O, S, j = new v(e); !j.eos(); ) {
                        if (x = j.pos,
                        C = j.scanUntil(o))
                            for (var A = 0, M = C.length; A < M; ++A)
                                u(k = C.charAt(A)) ? m.push(g.length) : _ = !0,
                                g.push(["text", k, x, x + 1]),
                                x += 1,
                                "\n" === k && b();
                        if (!j.scan(o))
                        ...
                        "=" === E ? (C = j.scanUntil(h),
                        j.scan(h),
                        j.scanUntil(s)) : "{" === E ? (C = j.scanUntil(a),
                        j.scan(d),
                        j.scanUntil(s),
                        E = "&") : C = j.scanUntil(s),
                        !j.scan(s))
            ...
            m.prototype.renderTokens = function(t, e, n, r) {
                for (var i, o, s, a = "", u = 0, l = t.length; u < l; ++u)
                    s = void 0,
                ...
                if (u) {
                    if (n(u))
                        for (var l = 0, c = u.length; l < c; ++l)
                            a += this.renderTokens(t[4], e.push(u[l]), i, o);
    ...
    695257: (t, e) => {
        ...
        function k(t, e, r) {
            ...
            if (null != e)
                ...
                e)
                    x.call(e, i) && !C.hasOwnProperty(i) && (o[i] = e[i]);
        ...
        e.cloneElement = function(t, e, r) {
            ...
            if (null != e) {
                ...
                for (l in e)
                    x.call(e, l) && !C.hasOwnProperty(l) && (i[l] = void 0 === e[l] && void 0 !== u ? u[l] : e[l])
            }
    ...
    732016: (t, e, n) => {
        ...
        const w = function(t) {
            ...
            return e && "string" == typeof t[0] && b.call(t, "index") && (n.index = t.index,
            n.input = t.input),
            n
        };
        var x = n(797990);
        ...
        var O = n(366711)
          , S = O.default ? O.default.prototype : void 0
        ...
        var z = "[object Arguments]"
          ...
          , W = "[object Object]"
          , q = {};
        q[z] = q["[object Array]"] = q["[object ArrayBuffer]"] = q["[object DataView]"] = q["[object Boolean]"] = q["[object Date]"] = q["[object Float32Array]"] = q["[object Float64Array]"] = q["[object Int8Array]"] = q["[object Int16Array]"] = q["[object Int32Array]"] = q["[object Map]"] = q["[object Number]"] = q[W] = q["[object RegExp]"] = q["[object Set]"] = q["[object String]"] = q["[object Symbol]"] = q["[object Uint8Array]"] = q["[object Uint8ClampedArray]"] = q["[object Uint16Array]"] = q["[object Uint32Array]"] = !0,
        q["[object Error]"] = q[B] = q["[object WeakMap]"] = !1;
        const G = function t(e, n, s, d, v, b) {
            var x, E = 1 & n, C = 2 & n, k = 4 & n;
            if (s && (x = v ? s(e, d, v, b) : s(e)),
            void 0 !== x)
                return x;
            if (!(0,
            R.default)(e))
            ...
            if (O) {
                ...
                var S = (0,
                _.default)(e)
                  , j = S == B || "[object GeneratorFunction]" == S;
                if ((0,
                P.default)(e))
                    return (0,
                    f.default)(e, E);
            ...
            if (A)
                return A;
            b.set(e, x),
            H(e) ? e.forEach((function(r) {
                x.add(t(r, n, s, r, e, b))
            }
            )) : (0,
            I.default)(e) && e.forEach((function(r, i) {
                x.set(i, t(r, n, s, i, e, b))
            }
            ));
            var M = k ? C ? y.default : m.default : C ? l.default : a.default
              , V = O ? void 0 : M(e);
            return (0,
            i.default)(V || e, (function(r, i) {
                V && (r = e[i = r]),
                (0,
                o.default)(x, i, t(r, n, s, i, e, b))
            }
            )),
            x
        }
    ...
    412189: (t, e, n) => {
        ...
        const f = function(t, e, n, r, i, o) {
            ...
            o.set(e, t); ++p < a; ) {
                var m = t[p]
                  , y = e[p];
                if (r)
                    var _ = s ? r(y, m, p, e, t, o) : r(m, y, p, t, e, o);
                if (void 0 !== _) {
                    if (_)
                        continue;
                    v = !1;
        ...
        var m = h.default ? h.default.prototype : void 0
          , y = m ? m.valueOf : void 0;
        const _ = function(t, e, n, r, i, o, s) {
            switch (n) {
            case "[object DataView]":
                ...
                e = e.buffer;
            case "[object ArrayBuffer]":
                return !(t.byteLength != e.byteLength || !o(new d.default(t), new d.default(e)));
            case "[object Boolean]":
            case "[object Date]":
            case "[object Number]":
                return (0,
        ...
        const x = function(t, e, n, r, i, o) {
            ...
            b.default)(t)
              , u = a.length;
            if (u != (0,
            b.default)(e).length && !s)
                return !1;
            for (var l = u; l--; ) {
                var c = a[l];
                if (!(s ? c in e : w.call(e, c)))
                    return !1
            }
            var f = o.get(t)
              , h = o.get(e);
            ...
            for (var p = s; ++l < u; ) {
                var v = t[c = a[l]]
                  , g = e[c];
                if (r)
                    var m = s ? r(g, v, c, e, t, o) : r(v, g, c, t, e, o);
        ...
        const D = function(t, e, n, i, o, s) {
            ...
            if (p && !h)
                ...
                a || (0,
                O.default)(t) ? f(t, e, n, i, o, s) : _(t, e, l, n, i, o, s);
            if (!(1 & n)) {
                var v = h && M.call(t, "__wrapped__")
                  , g = d && M.call(e, "__wrapped__");
                if (v || g) {
                    var m = v ? t.value() : t
                      , y = g ? e.value() : e;
                    return s || (s = new r.default),
    ...
    355762: (t, e, n) => {
        ...
        var l = n(366711)
          , c = n(728019)
          , f = n(898111)
          , h = l.default ? l.default.prototype : void 0
