(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[57565, 25214, 88741, 68984], {
    43681: e => {
        e.exports = {
            wrap: "wrap-Un5MtNUE",
            list: "list-Un5MtNUE",
    ...
    604e3: (e, t, o) => {
        ...
        o.d(t, {
            ...
            ListColor: () => i,
            changeDescription: () => C,
            createCrossTabSyncMiddleware: () => M,
            getCommands: () => $,
            getListByColor: () => D,
            getSymbolColor: () => A,
            getSymbolsByColor: () => P,
            ...
            share: () => F,
            shiftCommand: () => x,
            updatePersistedState: () => T
        });
        var i, n = o(655091), r = o(438253), s = o(650151), l = o(199669), a = o(50991), d = o(340958), c = o(173777), u = o(559986);
        !function(e) {
            e.Red = "red",
            e.Blue = "blue",
            e.Green = "green",
        ...
        n.createSlice)({
            ...
            reducers: {
                ...
                remove: (e, t) => {
                    const {color: o, symbols: i, silent: n} = t.payload
                      ...
                      , c = l.byColor[o];
                    if (void 0 === c || 0 === c.symbols.length)
                        return;
                    const u = new Set(i)
                      , h = c.symbols.filter((e => !u.has(e)));
                    if (!(0,
                    d.equalArrays)(h, c.symbols)) {
                        c.symbols = h;
                        for (const e of u)
                            delete l.bySymbol[e];
                        n || a.push({
                ...
                markMany: (e, t) => {
                    const {color: o, before: i, silent: n} = t.payload
                      , {lists: l, commands: a} = e
                      , {unique: c, exclusions: h} = function(e, t) {
                    ...
                    if (null !== o && void 0 !== h[o] && 1 === Object.keys(h).length) {
                        ...
                        (0,
                        s.assert)(void 0 !== t);
                        const _ = t.symbols.filter((e => !c.has(e)))
                          , v = (0,
                        u.getTargetIndex)(_, i, p);
                        if (void 0 === v ? _.push(...c) : _.splice(v, 0, ...c),
                        (0,
                        d.equalArrays)(_, t.symbols))
                            return;
                        {
                            const i = h[o];
                            (0,
                    ...
                    if (l.colors.includes(o)) {
                        ...
                        s.assert)(void 0 !== _);
                        const t = (0,
                        u.getTargetIndex)(_.symbols, i, p);
                        void 0 === t ? (_.symbols.push(...c),
                        n || (void 0 === h[o] ? a.push({
                            type: "append",
                            color: o,
                            symbols: [...c],
                ...
                renameSeparator: (e, t) => {
                    ...
                    (0,
                    s.assert)(void 0 !== a);
                    const d = a.symbols.indexOf(i);
                    -1 !== d && -1 === a.symbols.indexOf(n) && (a.symbols.splice(d, 1, n),
                    l || e.commands.push({
                ...
                share: (e, t) => {
                    const {lists: o, commands: i} = e
                      ...
                      , d = o.byColor[l];
                    void 0 !== d && d.shared !== n && (d.shared = n,
                    a || i.push({
                        type: "share",
                        color: l,
                        shared: n,
          ...
          , {markMany: f, setup: y, reset: b, remove: S, rename: w, changeDescription: C, renameSeparator: k, shiftCommand: x, share: F, updatePersistedState: T} = v.actions
          , {reducer: E} = v;
        function M(e, t, o=v) {
            return (0,
    ...
    276536: (e, t, o) => {
        ...
        o.d(t, {
            ...
            get_hours: () => T,
            get_minutes: () => E,
            get_minutes_from_midnight: () => P,
            get_minutes_with_hours: () => $,
            get_month: () => F,
            get_timezone: () => Y,
            get_year: () => x,
            is_leap_year: () => q,
        ...
        function D(e) {
            ...
            let o = n[t];
            return t > m + 1 && q(e.getUTCFullYear()) && (o += 1),
            o + e.getUTCDate()
        }
        function P(e) {
            return 60 * T(e) + E(e)
        ...
        class a {
            ...
            promoteGroup(e) {
                const t = this._getModalOrderEpoch()
                  , o = d(e, t);
                let i = this._groups.findIndex((e => d(e, t) === o))
                  , n = 0;
                for (; i < this._groups.length && d(this._groups[i], t) === o; ) {
                    const r = this._groups[i];
                    r === e ? n = 1 : d(r, t) === o && (this._groups[i - n] = r),
                    i++
                }
                this._groups[i - n] = e
            }
            ...
            sortGroups() {
                ...
                this._groups.sort(( (t, o) => d(o, e) - d(t, e)))
            }
            _getMinOrder() {
    ...
    31241: (e, t, o) => {
        ...
        var i = o(50959)
          ...
          , r = o(940194);
        function s(e) {
            const {click: t, mouseDown: o, touchEnd: s, touchStart: l, handler: a, reference: d} = e
              , c = (0,
            i.useRef)(null)
              , u = (0,
    ...
    430495: (e, t, o) => {
        ...
        class d extends i.PureComponent {
            ...
            render() {
                ...
                n.createPortal(i.createElement(c.Provider, {
                    value: this
    ...
    771813: (e, t, o) => {
        ...
        function r(e) {
            ...
            ,
            t.contextType = n.SwitchGroupContext,
            t
        }
    }
    ,
    ...
    45554: (e, t, o) => {
        ...
        function p(e) {
            ...
            i.useContext)(s.CustomBehaviourContext)
              , {size: o, intent: n="default", checked: l, className: a, enableActiveStateStyles: u=t.enableActiveStateStyles, disabled: p, onChange: _, title: m, id: g, name: v, value: f, tabIndex: y, role: b="switch", ariaDisabled: S, reference: w, ariaLabelledBy: C, ariaLabel: k, ...x} = e;
            return i.createElement("span", {
                ...
                onKeyDown: e => {
                    13 === (0,
                    c.hashFromEvent)(e) && e.currentTarget?.click()
                }
                ,
                onChange: _,
                disabled: p,
    ...
    355734: (e, t, o) => {
        "use strict";
        o.d(t, {
            createScopedVisibleElementFilter: () => c,
            getActiveElementSelectors: () => d,
    ...
    471802: (e, t, o) => {
        ...
        function v(e, t) {
            ...
            if (!o)
                return;
            !function(e, t) {
                const o = c.includes(t) ? d[t] : "";
                e.classList.remove(...c.map((e => d[e])).filter((e => !!e))),
            ...
            a.isMac)() ? window.innerHeight : document.body.clientHeight
              , h = t.vertical
              , _ = t.extendMargin || h && o.w < 20 || !h && o.h < 20;
            e.classList.toggle(p["common-tooltip--farther"], _),
            ...
            if (h) {
                const a = 10
                  ...
                  , _ = d - c
                  , v = (0,
                l.clamp)(o.y + o.h / 2, h, _) - g / 2
                  , f = v + g;
                e.style.left = b(o.x + o.w),
                e.style.top = b(v),
                v < a ? i.style.top = n.style.top = b(a - v) : f > d && (i.style.top = n.style.top = b(d - f));
                const {right: y} = (e.querySelector(":last-child") || i).getBoundingClientRect()
                  , S = y + 10 > s;
                e.classList.toggle(p["common-tooltip--direction_reversed"], S),
                e.classList.toggle(p["common-tooltip--direction_normal"], !S);
                let w = S ? "after" : "before";
                (0,
                r.isRtl)() ? (w = t.otr ? "after" : w,
                w = t.otl ? "before" : w) : (w = t.otr ? "before" : w,
                w = t.otl ? "after" : w),
                m.classList.toggle(p["common-tooltip__ear-holder--before"], "before" === w),
                m.classList.toggle(p["common-tooltip__ear-holder--after"], "after" === w),
                "after" === w && (e.style.left = "auto",
                e.style.right = b(s - o.x))
            } else {
                const r = o.x - (i.offsetWidth - o.w) / 2
                  , l = s - e.offsetWidth - 20 <= 0 ? (s - e.offsetWidth) / 2 : 10
                  , a = s - l - e.offsetWidth
                  , d = Math.max(l, Math.min(r, a));
                e.style.left = b(d);
                const c = a < r;
                e.classList.toggle(p["common-tooltip--direction_reversed"], c),
                e.classList.toggle(p["common-tooltip--direction_normal"], !c);
                const h = function(e, t, o, i) {
                    if (e.above)
                        return E(t, i) ? "above" : "below";
                    if (e.below)
                        return function(e, t, o) {
                            return o.y + o.h + t + 10 < e
                        }(t, o, i) ? "below" : "above";
                    return E(o, i) ? "above" : "below"
                }(t, u, g, o);
                "above" === h ? e.style.bottom = b(u - o.y) : e.style.top = b(o.y + o.h),
                m.classList.add("above" === h ? p["common-tooltip__ear-holder--above"] : p["common-tooltip__ear-holder--below"]);
                const {left: _} = i.getBoundingClientRect();
                let v = Math.trunc(o.x + o.w / 2 - (_ + i.clientWidth / 2));
                e.style.left = b(d + v),
                e.style.width = b(i.clientWidth + n.clientWidth),
                v = c ? Math.max(0, v) : Math.min(0, v),
                n.style.left = b(-v),
                i.style.left = b(-v)
            }
        }
    ...
    713438: (e, t, o) => {
        ...
        function a(e, t, o=n.LogoSize.Medium) {
            ...
            (0,
            n.getLogoUrlResolver)().getCountryFlagUrl(e.toUpperCase(), o)) : d(t)
        }
        function d(e) {
    ...
    625214: (e, t, o) => {
        ...
        class b {
            ...
            bindToChartWidgetCollection(e) {
                ...
                const t = function(e) {
                    const t = (0,
                    d.combine)(( () => e.getAll().filter((e => e.isVisible() && e.hasModel())).map((e => (0,
                    c.createWVFromGetterAndSubscription)(( () => e.model().mainSeries().symbol()), e.model().mainSeries().symbolResolved()).ownership()))), e.chartModels().weakReference(), e.layout.weakReference());
                    return (0,
                    d.accumulate)((e => e), t.ownership())
                }(e);
                t.subscribe((e => {
                ...
                window.user.do_not_track || n.symbolResolvingActive().subscribe((e => {
                    ...
                    m.getTracker)().then((e => {
                        null !== e && e.trackChartSymbols({
                            ...
                            platform: (0,
                            p.getPlatform)(),
                            isExpert: window.user.declared_status === _.UserStatus.Pro
                        })
                    }
                    ))
                }
        ...
        ;
        {
            ...
            S.setSymbolAndLogInitiator(t, "initial data", !1, !0)
        }
        ...
        class s {
            ...
            collectSymbolLogoUrls(e, t) {
                ...
                s.length < 2)
                    return s;
                const l = s.some(d)
                  , a = s.every((e => !e.includes("country") || d(e)));
                return l && a ? s.filter((e => !d(e))) : s;
                function d(e) {
    ...
    687341: (e, t, o) => {
        ...
        function c(e) {
            ...
            i.useState)({
                ...
                l.isOnMobileAppPage)(d[e]),
                isRtl: (0,
                a.isRtl)(),
                locale: window.locale,
                renderMode: e.renderMode ?? "legacy"
            });
            return i.createElement(s.AppContext.Provider, {
                value: t
            }, e.children)
        }
        function u(e, t, o="legacy") {
            const s = i.createElement(c, {
                renderMode: o
            }, e);
            if ("modern" === o) {
                const e = (0,
    ...
    62802: (e, t, o) => {
        ...
        "local" === window.environment ? 5e3 : 12e4)
          , _ = 10
          , m = window.TradingView.onWidget?.() ? "tradingview-widget" : "tradingview"
          , g = m + ".";
        let v, f, y, b = !1, S = null, w = {}, C = [];
        ...
        const x = () => !(S || window.is_authenticated)
          , F = e => g + e
          , T = (0,
        i.getLogger)("Lib.TVSettings")
          , E = e => {
            ...
            n.isFeatureEnabled)("disable_save_settings"))
                return void T?.logWarn("Settings flashing has been skipped because of disable_save_settings featuretoggle");
            if (u.enabled("widget"))
                return;
            if (x())
                return;
          ...
          , A = (e, t={}) => {
            if (S)
                null == w[e] ? S.removeValue(e) : S.setValue(e, w[e]);
            else if (x())
                try {
                    null == w[e] ? d.TVLocalStorage.removeItem(F(e)) : d.TVLocalStorage.setItem(F(e), w[e])
                } catch (e) {}
            else
                C.push(e),
                v || (v = setTimeout(M, p));
        ...
        a.TVXWindowEvents.on("settings", (e => {
            ...
            null == t.value ? delete w[t.key] : w[t.key] = t.value
        }
        ));
        const V = e => {
          ...
          , U = () => {
            ...
            for (let t = d.TVLocalStorage.length; t--; ) {
                const o = d.TVLocalStorage.key(t);
                if (!o || !q(o))
                    continue;
                const i = o.substring(g.length);
                e && !V(i) || (w[i] = d.TVLocalStorage.getItem(o))
            }
        }
          , j = e => {
            w = {};
            ...
            (e => {
                for (let t = d.TVLocalStorage.length; t--; ) {
                    const o = d.TVLocalStorage.key(t);
                    o && q(o) && (e && R(o.substring(g.length), d.TVLocalStorage.getItem(o)),
                    d.TVLocalStorage.removeItem(o))
                }
            }
            )(t)
        }
          , z = () => {
            ...
            for (let t = d.TVLocalStorage.length; t--; ) {
                const o = d.TVLocalStorage.key(t);
                if (0 === o.indexOf(e)) {
                    const t = o.replace(e, m + ".");
                    d.TVLocalStorage.setItem(t, d.TVLocalStorage.getItem(o)),
                    d.TVLocalStorage.removeItem(o)
                }
            }
        }
          , H = new c.Delegate;
        function G(e) {
            null !== e ? (S ? j(S.initialSettings || {}) : x() ? (z(),
            U()) : j(e || {}),
            H.fire()) : b = !0
        }
        function X(e) {
        ...
        document.addEventListener("visibilitychange", ( () => {
            "hidden" !== document.visibilityState && !0 !== document.hidden || E()
        }
        )),
    ...
    526225: (e, t, o) => {
        ...
        function c(e) {
            ...
            (0,
            n.trackEvent)("Sync User Data", "Different Pro Plan", d(t))),
            o !== window.is_authenticated && (window.is_authenticated = o,
            l && window.loginStateChange.fire(),
            (0,
            n.trackEvent)("Sync User Data", "Different Auth", d(t))),
        ...
        async function u(e) {
            try {
                ...
                !function(e, t) {
                    403 === t.status && ["not_authenticated", "login_required"].includes(t.type || "") ? c({
                        source: e,
                        isAuthenticated: !1,
                        proPlan: void 0
    ...
    137674: (e, t, o) => {
        ...
        var i = o(2606)
          ...
          , r = o(777453);
        async function s(e) {
            Promise.all([o.e(79706), o.e(18883), o.e(98185), o.e(46195), o.e(15371), o.e(32937), o.e(83439), o.e(92537), o.e(98933), o.e(38752), o.e(25563), o.e(97540), o.e(72232), o.e(78894), o.e(87833), o.e(66032), o.e(87265), o.e(43329), o.e(51513), o.e(34943), o.e(3359), o.e(16990), o.e(95275), o.e(37463), o.e(95542), o.e(61031), o.e(4697), o.e(45073), o.e(82321), o.e(55091), o.e(47793), o.e(12831), o.e(77912), o.e(88536), o.e(530), o.e(50996)]).then(o.bind(o, 768175)).then((t => {
        ...
        let d = null;
        function c(e, t) {
            if (d && i.isDetailsReady.unsubscribe(d),
            d = () => {
        ...
        function h(e, t) {
            ...
            r.newsPathToGroup)(e ?? "");
            t ? async function(e) {
                (await Promise.all([o.e(2673), o.e(18883), o.e(98185), o.e(46195), o.e(15371), o.e(32937), o.e(83439), o.e(61681), o.e(98933), o.e(38752), o.e(19190), o.e(25563), o.e(97540), o.e(72232), o.e(87833), o.e(66032), o.e(71450), o.e(13672), o.e(19365), o.e(51513), o.e(93240), o.e(34943), o.e(3359), o.e(11069), o.e(1462), o.e(95275), o.e(45868), o.e(84030), o.e(40984), o.e(27290), o.e(63213), o.e(75329), o.e(72929), o.e(13284), o.e(82321), o.e(12831), o.e(80241), o.e(14252), o.e(84482)]).then(o.bind(o, 23154))).renderNewsDialog(e)
            }(i) : c(i)
        }
        function p(e, t) {
            const i = (0,
            ...
            t ? async function(e) {
                (await Promise.all([o.e(24054), o.e(18883), o.e(98185), o.e(46195), o.e(15371), o.e(32937), o.e(83439), o.e(92537), o.e(61171), o.e(38752), o.e(19190), o.e(25563), o.e(97540), o.e(72232), o.e(87833), o.e(71450), o.e(20563), o.e(19365), o.e(51513), o.e(34943), o.e(3359), o.e(95275), o.e(45868), o.e(38110), o.e(48598), o.e(1508), o.e(26383), o.e(63922), o.e(61031), o.e(59633), o.e(82321), o.e(47793), o.e(12831), o.e(24951), o.e(6421), o.e(94673)]).then(o.bind(o, 790348))).renderIdeasDialog(e)
            }(i) : c(i)
        }
        function _(e, t, o) {
            c((0,
            ...
            return (t = class extends i.PureComponent {
                ...
                _calcTargetProps(e, t, o) {
                    ...
                    case "top":
                        ...
                        break;
                    case "bottom":
                        d = r[o.vertical] - s.height;
                        break;
                    case "middle":
                        d = r[o.vertical] - s.height / 2
                    }
                    switch (t.horizontal) {
                    case "left":
                        a = r[o.horizontal];
                    ...
                    return "number" == typeof this.props.attachmentOffsetY && (d += this.props.attachmentOffsetY),
        ...
        class _ extends i.PureComponent {
            render() {
                ...
                return i.createElement(h, {
                    ...
                    className: l,
                    root: o
                }, i.createElement(d.DropdownContainer, {
    ...
    150881: (e, t, o) => {
        ...
        i.forwardRef)(( (e, t) => {
            ...
            i.useRef)(null);
            return (0,
            i.useImperativeHandle)(t, ( () => d.current)),
            (0,
            i.useLayoutEffect)(( () => {
                if (s.CheckMobile.iOS())
                    return a++,
                    null !== d.current && (l ? 1 === a && (document.body.style.overscrollBehavior = "none") : (0,
                    n.disableBodyScroll)(d.current, {
                        allowTouchMove: c(d)
                    })),
                    () => {
                        a--,
                        null !== d.current && (l ? 0 === a && (document.body.style.overscrollBehavior = "") : (0,
                        n.enableBodyScroll)(d.current))
                    }
            }
            ), []),
            i.createElement("div", {
    ...
    518643: (e, t, o) => {
        "use strict";
        o.d(t, {
            getColumnSetNameForSnowPlow: () => d,
            getFilterSetNameForSnowPlow: () => c,
    ...
    554620: (e, t, o) => {
        "use strict";
        o.d(t, {
            getDefaultMarketForLocale: () => m,
            getDefaultStockMarket: () => g,
            getExchangesByMarkets: () => k,
            getMarketFieldValuesByScreenerType: () => w,
            getMarketsByScreenerType: () => v,
            getUnavailableWidgetExchangesMap: () => E,
            getUnavailableWidgetMarkets: () => F,
        ...
        const d = o(161379)
          ...
          , u = {
            crypto: {
                icon: `<span class="tv-screener-market-select__item-bitcoin">${d}</span>`,
                get title() {
          ...
          , p = "forex"
          , _ = "crypto";
        function m(e, t="stock") {
            return "forex" === t ? p : "crypto" === t ? _ : (0,
        ...
        function v(e) {
            return "stock" === e ? l : "forex" === e ? c : "crypto" === e ? u : l
        }
        const f = {
            america: {
    ...
    696788: (e, t, o) => {
        ...
        const r = {
          ...
          , a = {
            ...
            processADXSignal: (e, t, o, i, n, r, a) => {
                if (null === t || null === o || null === i)
                    return e;
                const d = l.computeADXSignal(t, o, i, n, r);
                return `${e} ${s(d, a.displaySignal, !0)}`
            }
            ,
          ...
          , d = () => [r.STRONG_BUY.title, r.BUY.title, r.NEUTRAL.title, r.SELL.title, r.STRONG_SELL.title]
          , c = e => {
            let t, o;
    ...
    905520: (e, t, o) => {
        ...
        class m extends u.PropertyBase {
            constructor(e, t) {
                if (super(),
                this._childs = [],
                this._dependents = [],
    ...
    218778: (e, t, o) => {
        ...
        function i(e) {
            if (!e)
                return "";
            if (["NYSE ARCA & MKT", "AMEX"].includes(e))
                return "NYSE Arca";
            if (["Cboe BZX"].includes(e))
                return "Cboe One";
            if (["FTSEST"].includes(e))
                return "FTSE ST";
            const t = /^(CME|COMEX|CBOT|NYMEX)_MINI$/.exec(e);
            return null !== t ? t[1] : e
        }
        o.d(t, {
    ...
    388741: (e, t, o) => {
        ...
        o.d(t, {
            actualSymbol: () => ge,
            chartStyleStudyId: () => j,
            createSeriesFormatter: () => X,
            displayedSymbolExchange: () => me,
            displayedSymbolName: () => _e,
            extractLineToolSymbolFromSymbolInfo: () => de,
            getChartStyleByResolution: () => U,
            getDefaultStyle: () => q,
            getLastUsedRawDataStyle: () => V,
            getLastUsedSingleValueBasedStyle: () => W,
            getLastUsedStyle: () => N,
            getSeriesDisplayErrorWV: () => Ee,
            getSeriesPriceFormattingState: () => G,
            getSourceForEconomySymbol: () => he,
            getSymbolDelaySeconds: () => Me,
            getSymbolExchange: () => xe,
            getTranslatedChartStyleName: () => F,
            hasVolume: () => we,
            isCloseBasedSymbol: () => ye,
            isConvertedToOtherCurrency: () => Q,
            isConvertedToOtherUnit: () => ie,
            isEconomicSymbol: () => Ce,
            isFutureContinuousSymbolWithBackajustment: () => Fe,
            isFuturesContractSymbol: () => Te,
            isHLCBasedStyle: () => B,
            isMeasureUnitSymbol: () => be,
            isPriceSourceStyle: () => H,
            isRangeBasedStyle: () => E,
            isRangeStyle: () => A,
            isRawDataStyle: () => L,
            isRegularSessionId: () => fe,
            isRequiringRestartSeriesStyles: () => T,
            isSingleValueBasedStyle: () => I,
            isSpreadSymbolWithManyLegs: () => ke,
            isStyleSupportedForReplay: () => P,
            isTimeBasedStyle: () => D,
            isValidStyle: () => $,
            measureUnitId: () => Se,
            preparePriceAxisProperties: () => z,
            proSymbol: () => ve,
            setLastUsedRawDataStyle: () => O,
            setLastUsedStyle: () => R,
            styleChangeRequiresRestart: () => M,
            symbolBaseCurrency: () => Z,
            symbolCurrency: () => Y,
            symbolCurrencyConvertible: () => K,
            symbolHasEconomicEvents: () => ae,
            symbolHasElectronicSession: () => se,
            symbolHasPreOrPostMarket: () => re,
            symbolHasSeveralSessions: () => le,
            symbolOriginalCurrency: () => J,
            symbolOriginalUnit: () => oe,
            symbolTitle: () => pe,
            symbolTitleSeparator: () => ue,
            symbolToSaveInState: () => ce,
            symbolUnit: () => te,
            symbolUnitConvertibleGroupsIfExist: () => ne
        });
        var i = o(444372)
          , n = o(62802)
          , r = o(125226)
        ...
        function P(e) {
            return !(!S && 8 === e || 17 === e || 18 === e || 20 === e) && D(e)
        }
        function $(e) {
            return E(e) || D(e)
        }
        ...
        function R(e, t) {
            $(e) && (11 !== e && n.setValue("chart.lastUsedStyle", e),
            L(e) && O(e),
            ye(t) && I(e) && n.setValue("chart.lastUsedSingleValueBasedStyle", e))
        }
        function O(e) {
        ...
        function U(e, t) {
            const o = A(t)
              , i = d.Interval.isRange(e);
            return !o && i ? q(!0) : o && !i ? q(!1) : t
        }
        function j(e, t) {
        ...
        function G(e, t="default", o=!1) {
            let i, n, r, s = 100, l = 1;
            if ("default" === t)
                null != e && (({pricescale: s, minmov: l, minmove2: n, fractional: i} = e),
        ...
        function X(e, t, o=!1) {
            const {priceScale: i, minMove: n, fractional: r, minMove2: s, variableMinTick: l} = G(e, t, o);
            if (null != e) {
                const a = e.format;
        ...
        function ae(e) {
            ...
            _.isCFDSymbol)(e.type, e.typespecs) || (0,
            l.hasCryptoTypespec)(e.typespecs || []))
        }
        function de(e, t) {
            return (0,
            f.extractSymbolNameFromSymbolInfo)(e, null, !0, !0) || t
        }
        function ce(e, t) {
        ...
        const ue = "·";
        function he(e, t) {
            return Ce(e) ? e.source2?.description ?? null : null
        }
        function pe(e, t, o="exchange") {
            const i = he(e) ?? e[o];
            return t || b ? e.name : `${e.name} ${ue} ${i}`
        }
        function _e(e) {
            let t = e && (function(e) {
                return (0,
        ...
        function xe(e) {
            ...
            return (0,
            s.onWidget)() || (0,
            l.isForexSymbol)(e.type) ? e.exchange : (0,
            v.redefineExchangeName)(e.listed_exchange)
        }
        function Fe(e) {
            return null !== e && (0,
    ...
    262307: (e, t, o) => {
        ...
        const _ = [{
            ...
            content: [],
            screeners: [c.Stock, c.StockCompact, c.Forex, c.Futures, c.ContinuousFutures, c.Cfd, c.Crypto, c.CryptoMkt, c.CryptoMktBySymbol, c.CryptoBySymbol, c.Sector, c.Industry, c.Currency, c.Bonds, c.PreMarket, c.PostMarket],
            showOnWidget: !0
        }, {
            id: "performance",
            ...
            content: [],
            screeners: [c.Stock, c.StockCompact, c.Forex, c.Futures, c.ContinuousFutures, c.Cfd, c.Crypto, c.CryptoMkt, c.CryptoBySymbol, c.CryptoMktBySymbol, c.Sector, c.Industry, c.Currency, c.Bonds, c.PreMarket, c.PostMarket],
            showOnWidget: !0
        }, {
            id: "extended_hours",
            ...
            screeners: [c.Stock, c.StockCompact, c.PreMarket, c.PostMarket],
            showOnWidget: !0
        }, {
            id: "dividends",
            ...
            content: [],
            screeners: [c.Stock, c.StockCompact, c.Forex, c.Futures, c.ContinuousFutures, c.Cfd, c.Crypto, c.CryptoMkt, c.CryptoMktBySymbol, c.CryptoBySymbol, c.Currency, c.Bonds, c.PreMarket, c.PostMarket],
            showOnWidget: !0
        }, {
            id: "moving_averages",
          ...
          , m = [u.LogoId, "name", "market_cap_basic", "earnings_per_share_forecast_next_fq", "earnings_per_share_fq", "eps_surprise_fq", "eps_surprise_percent_fq", "revenue_forecast_next_fq", "revenue_fq", "earnings_release_next_date", "earnings_release_next_calendar_date", "earnings_release_next_time", "description", "type"];
        function g(e) {
            const t = {
                screenerType: c.Stock,
                markets: ["stock"],
                isCompact: !1,
                subtype: "",
                isOnWidget: !1
        ...
        var f = o(536794)
          ...
          , k = o(909456);
        var x = o(976531);
        const F = new RegExp(/0+$/);
        class T extends S.PriceFormatter {
            constructor(e={}) {
        ...
        function B(e, t) {
            ...
            /(change|change_abs).\d{1,3}/.test(e) || Ze[e] && Ze[e].useDefaultTimeIntervalFromFieldName)
                return e.replace(".", "|");
            if (!t || t === $ || Ze[e] && Ze[e].useDefaultTimeInterval)
                return e;
            const o = I(t);
            if (o) {
                const t = o.value || "";
        ...
        function V(e) {
            ...
            if (Array.isArray(e))
                ...
                [t,o] = U(e);
            return o = [...new Set(o)],
            t.length && o.length ? [j("type", t), j("subtype", o)] : t.length ? [j("type", t)] : [j("subtype", o)]
        }
        function q(e) {
            const t = []
              , o = [].concat(e);
        ...
        const ke = [{
          ...
          , Fe = new S.PriceFormatter({
            priceScale: 100,
            minMove: 1,
            fractional: !1
        })
          , Te = new S.PriceFormatter({
            priceScale: 1,
            minMove: 1,
            fractional: !1
        })
          , Ee = new w.VolumeFormatter
          , Me = new C.PercentageFormatter
        ...
        A.getRecommendsRange)()
          ...
          , Be = ["today", "yesterday", "prev_five", "prev_week", "this_week", "this_month"]
          , Le = ["today", "tomorrow", "next_five", "next_week", "this_week", "this_month"]
          ...
          , ze = ["dr", "etf", "common", "preferred", "closedend", "etn", "reit", "unit", "mutual", "trust", "structured"]
        ...
        const Ze = {
            name: {
                ...
                additionalFormatter: (e, t, o, i, n, r="") => {
                    ...
                    return ( (e, t, o, i, n) => {
                        const r = new E.DataModeIndicator({
                        ...
                        let l = e ? (0,
                        M.getTranslatedSymbolDescription)(s).toString().toUpperCase() : "";
            ...
            type: {
                ...
                mutateDisplayValue: (e, t, o=!1) => t && je[t] ? je[t][o ? 1 : 0] : je[e] ? je[e][o ? 1 : 0] : "",
            ...
            earnings_release_date: {
                ...
                sortable: !1,
                useDefaultRange: !0,
                defaultRange: Ie.filter((e => -1 !== Be.indexOf(e.key))).map((e => e.name)),
                sourceRange: Ie,
            ...
            earnings_release_next_date: {
                ...
                sortable: !1,
                useDefaultRange: !0,
                defaultRange: Ie.filter((e => -1 !== Le.indexOf(e.key))).map((e => e.name)),
                sourceRange: Ie,
        ...
        function et(e, t) {
            for (let o = 0; o < e.length; ++o) {
                const i = e[o];
                i.left && Ze[i.left] && (i.left = B(i.left, t))
            }
        }
        function tt(e, t, o, i) {
            ...
            if ("function" == typeof Ze[e].customFilterCondition) {
                ...
                if (t)
                    return Array.isArray(t) ? et(t, i) : ("candlestick" === e && (t.left = t.left.split(",").map((e => B(e, i))).join(",")),
                    t.left && Ze[t.left] && (t.left = B(t.left, i))),
        ...
        function rt(e, t) {
            ...
            Ze.sector.mutateFilterConditionValue = e => !!e && (Array.isArray(e) ? e.map((e => Ne(e, $e))) : Ne(e, $e))),
            "stock" === e) {
                Ze.sector.title = p.t(null, void 0, o(99804)),
                Ze.sector.shortTitle = p.t(null, void 0, o(99804)),
                Ze.type.customFilterCondition = V,
                Ze.type.defaultRange = ze,
                Ze.name.defaultRange = ze,
            ...
            Ze.maturity_date = {
                ...
                align: "right",
                mutateDisplayValue: L.mutateSimpleDate
            }),
        ...
        function at() {
            ...
            Ze.earnings_release_next_time = {
                ...
                mutateDisplayValue: (t, o, i, n) => {
                    const r = Ze.earnings_release_next_date.value
                      , s = e(r, o, i, n);
                    return s ? Ve((l = s).toString(), lt) || l : dt;
                    var l
                }
                ,
                category: 2
            ...
            Ze.earnings_release_next_date = Object.assign(Ze.earnings_release_next_date, {
                ...
                defaultRange: Ie.map((e => e.name)),
                resettableFilter: !1,
                mutateDisplayValue: (e, t, o, i) => {
                    if (!o && t)
                        return De.format(t);
                    if (i.value) {
                        const e = qe(i.value, Ie);
                        if (e) {
                            const i = Ue(e);
                            if (i) {
                                if (t && ct(t, i))
            ...
            Ze.earnings_release_next_calendar_date = {
                ...
                mutateDisplayValue: (e, t, o) => {
                    const i = qe(Ze.earnings_release_next_date.value, Ie);
                    if (i) {
                        const o = Ue(i);
                        if (o && ct(t, o))
                            return e
                    }
                    return o ? De.format(o) : dt
                }
            },
            ...
            Ze.revenue_forecast_next_fq = {
                ...
                mutateDisplayValue: (e, t, o) => {
                    ...
                    return o ? Ee.format(o) : dt
                }
            },
            ht()
        }
        const dt = '<span class="tv-screener-table__cell--color-normal">—</span>';
        function ct(e, t) {
            return function(e, t) {
                const o = t[0]
                  , i = t[1];
        ...
        const ut = e => {
            ...
            e.mutateDisplayValue = (e, t) => {
                const o = qe(Ze.earnings_release_next_date.value, Ie);
                if (o) {
                    const e = Ue(o);
                    if (e && ct(t, e))
                        return dt
        ...
        function mt(e, t, o, i) {
            const n = e + ";" + t + ";" + o + ";" + i;
            return _t[n] || (_t[n] = new S.PriceFormatter({
                priceScale: e,
                minMove: t,
                fractional: o,
                minMove2: i
        ...
        function Ft(e, t) {
            ...
            return Object.keys(e).filter((t => {
                ...
                content: e[t] ? e[t].title + (e[t].stocks.length ? ` (${Tt(t, e)})` : "") : t,
                value: t
        ...
        o(335048))
          , Pt = o(713438);
        var $t, It = o(290484), Bt = o(207678), Lt = o(740203), Rt = o(31214), Ot = o(242651), Nt = (o(236550),
        o(337793),
        o(810047),
        o(228931)), Wt = (o(670431),
        o(707934)), Vt = o(779923), qt = o(406103), Ut = o(746849), jt = o(104461);
        !function(e) {
            e[e.None = 0] = "None",
            e[e.Widget = 1] = "Widget",
            e[e.Site = 2] = "Site"
        ...
        class ao {
            ...
            setFieldsPopup(e, t, i) {
                ...
                const s = so('<div class="tv-screener-fields-popup__search-wrap">').appendTo(r)
                  ...
                  , d = so('<div class="tv-screener-fields-popup__items-wrap tv-dropdown-behavior__inscroll">').appendTo(a);
                "header_fields-button" === e.attr("data-name") && d.attr({
                    "data-name": "header_fields_popup"
                });
                const c = so('<div class="tv-screener-fields-popup__item tv-screener-fields-popup__item--no-matches js-hidden">No matches</div>').appendTo(r);
                l.on("change input", (e => {
                    ...
                    )) : d.find(".js-fields-item").removeClass("js-hidden"),
                    c.toggleClass("js-hidden", !!d.find(".js-fields-item:not(.js-hidden)").size()),
            ...
            setFieldSetsPopupContent(e) {
                ...
                zt.appendEllipsis)(p.t(null, void 0, o(819213)))}</div>`).prepend(so(o(470088)).attr({
            ...
            setFilterSetsPopupContent() {
                ...
                zt.appendEllipsis)(p.t(null, void 0, o(432248)))}</div>`).prepend(so(o(470088)).attr({
                    class: "tv-screener-toolbar__button-icon",
                    width: "20",
                    height: "14",
                    style: "top: -2px; margin-right: 10px;"
            ...
            setSelectPopup(e, t) {
                const {wrapClass: o, buttonClass: i, dropdownClass: n} = e
                  ...
                  , d = so('<div class="tv-dropdown-behavior__scroll js-container">').appendTo(a)
                  , c = so('<div class="tv-dropdown-behavior__inscroll js-content">').appendTo(d);
                return s.on("beforeOpenMenu", ( () => {
                    d.css("maxHeight", so(window).height() - l.offset().top + so(window).scrollTop() - 45)
                }
            ...
            setRefreshIntervalsPopup(e) {
                ...
                o.on("click", ".js-interval", (e => {
                    ...
                    setTimeout(( () => t.tvDropdown("close")), Dt.dur / 2),
            ...
            setSelectIntervalContent(e, t, o= () => {}
                ...
                e.on("afterOpenMenu", ( () => {
                    t.on("click", ".js-select-interval", (i => {
                        ...
                        let r = I(so(i.currentTarget).data("interval"));
                        if (!r || n === r.id)
                            return;
                        ...
                        Rt.runOrGoPro)(( () => {
                            ...
                            r = I("1d")) : (t.find(".tv-screener-popup__select-interval-active").removeClass("tv-screener-popup__select-interval-active"),
        ...
        var wo = [p.t(null, void 0, o(580066)), p.t(null, void 0, o(279304)), p.t(null, void 0, o(856135)), p.t(null, {
            context: "study"
        }, o(786575))];
        class Co {
            constructor(e, t, o) {
            ...
            showFiltersDialog(e) {
                return Promise.all([o.e(57335), o.e(41392), o.e(71761), o.e(64935), o.e(71353), o.e(30938), o.e(37384)]).then(o.bind(o, 858510)).then(( ({createTabbedDialog: t}) => {
                    ...
                    const o = this._categories.map((e => ({
                      ...
                      , {dialog: i, tabs: n} = t({
                        tabs: o,
                        additionalHeaderContent: So.filtersSearch,
                    ...
                    ;
                    this.$filtersPopup = bo(So.filtersBody),
        ...
        function Wo(e) {
            const t = Object.keys(e.modes)
              ...
              , [i,n] = $o.useState(t[0]);
            return $o.createElement(Ro.CustomBehaviourContext.Provider, {
        ...
        function Vo(e) {
            return $o.createElement("span", {
                className: Lo()(No.modeTitle, e.isActive && No.modeTitleActive)
            }, e.title)
        }
        var qo = o(118821)
          , Uo = o(43681)
        ...
        var Yo = o(690863);
        class Jo extends $o.PureComponent {
            constructor(e) {
                super(e),
            ...
            render() {
                const e = this._getFirstHiddenItemIndex()
                  ...
                  , s = r >= 0
                  , l = $o.createElement(Go.OutsideEvent, {
                    handler: this._onOutsideClick,
                    click: !0
                }, (e => $o.createElement("div", {
                    ref: e => e && (this._dropdownParent = Io.findDOMNode(e))
                }, $o.createElement("div", {
                    className: Bo(qo.item, {
                        [qo.active]: s
                    }),
                    ...
                    className: Bo(qo.itemContent, qo.dropdownItem, {
                        [qo.active]: s
                    })
                }, $o.createElement(Ho.Icon, {
                    className: Bo(qo.dropdownIcon, {
                        [qo.active]: this.state.isOpened
                    }),
                    icon: Yo
                }), $o.createElement(zo.DropdownList, {
                    isOpened: this.state.isOpened,
                    items: n,
                    selected: s ? r : void 0,
                    ...
                    top: 27,
                    right: 0,
                    itemsClassName: Bo(Uo.bluishItem, qo.dropdownListItem),
                    selectedClassName: this.props.selectedItemClassName,
                    maxHeight: this._getDropdownHeight()
                }))))));
                return $o.createElement(jo.Measure, {
                    onResize: this._onElementResize
                }, (e => $o.createElement("div", {
                    className: Bo(qo.elementWrap, this.props.className),
                    ref: e
                }, $o.createElement("div", {
        ...
        var yi = o(586240)
          , bi = o(779893);
        const Si = parseInt(yi["size-sticky-symbol-header-height"]);
        function wi(e) {
            const {$toolbar: t} = e
              , o = t.outerHeight()
              , i = e.table.$stickyHeader
              , n = document.querySelector(".js-sticky-symbol-header-container") ? 64 + Si : 64;
            function r(t) {
        ...
        function ki(e) {
            ...
            n();
            const {$wrap: d, $button: c, $dropdownContent: u} = r(a);
            return s(d, c, u),
            (t || o) && (t ? d.insertBefore(t) : d.appendTo(o),
            l(d, c, u)),
            c
        }
        var xi, Fi = o(137674), Ti = o(212363);
        !function(e) {
            e[e.Header = 0] = "Header",
            e[e.Table = 1] = "Table"
        }(xi || (xi = {}));
        ...
        function Mi(e, t, i) {
            return async function() {
                ...
                return Ei[i].prepend ? function(e, t) {
        ...
        function Ai(e, t, i) {
            ...
            return Mi(e, t, i).then((e => {
                ...
                const e = Ei[i].description;
                n._model.trackEvent(e)
            }
            ))
        }
        var Di, Pi = o(990266), $i = o(810978), Ii = o(324020), Bi = o(301393), Li = o(702008), Ri = o(779893);
        function Oi(e, t) {
            const {view: o} = e
              , i = o._bridge
              , n = t.default
        ...
        function Ni(e, t) {
            ...
            return {
                addToWatchListAction: new t({
                    ...
                    onExecute: () => {
                        (0,
                        $i.runOrSigninWithFeature)(( () => {
                            const e = i._getWatchlist();
                            e && (e.addSymbols(a),
                            (0,
                            Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Di.AddToWatchlist,"row",!0)))
                        }
                        ), {
                            feature: "watchList",
                    ...
                    openSymbolPageAction: new t({
                        ...
                        options: {
                            ...
                            onExecute: () => {
                                ...
                                (0,
                                Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Di.OpenSymbolPage,"row",!0))
                            }
                        }
                    })
                }
                    ...
                    openChartAction: new t({
                        ...
                        options: {
                            ...
                            onExecute: () => {
                                ...
                                e && (e(r, !0),
                                (0,
                                Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Di.OpenChart,"row",!0)))
                            }
                        }
                    })
                }
                ...
                addToTextNotesAction: new t({
                    ...
                    options: {
                        ...
                        onExecute: () => {
                            ...
                            ai.runOrSignIn)(( () => {
                                (0,
                                Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Di.AddTextNote,"row",!0)),
                                window.widgetbar?.setPage("base"),
                                (0,
                                Fi.createSymbolNote)(i)
                            }
                            ), {
        ...
        const cn = "screener.showCurrencyLabel";
        function un() {
            return n.getBool(cn, !0)
        }
        var hn = o(366619)
          , pn = o(267562)
          , _n = o(182951)
        ...
        class fn {
            constructor(e) {
                ...
                this.fieldsOrderChange = new Ui.Delegate,
                this._columnsMap = new Map,
                this.afterFixCols = new Ui.Delegate,
                ...
                this.dragStarted = new ji.WatchedValue,
            ...
            updateSortField(e, t) {
                ...
                o.find(".js-table-sort").empty().addClass(`tv-screener-table__sort--${t}`).append("asc" === t ? _n : mn))
            }
            highlightCell(e, t, o) {
                    ...
                    const l = e.pageX || e.originalEvent.touches[0].pageX
                      , a = e => {
                        ...
                        const c = i.offset().left
                          , u = i.outerWidth()
                          , h = t.outerWidth()
                          , p = Math.max(c, Math.min(c + u - h, r + d))
                          , _ = p + h / 2;
                        let m = vn()
                          , g = !1;
                        const v = t.prev();
                        if (v.size() && ((0,
                        Gt.isRtl)() ? _ > v.offset().left + v.outerWidth() / 2 : p <= c || _ < v.offset().left + v.outerWidth() / 2))
                            m = v;
                        else {
                            const e = t.next();
                            if (e.size() && !e.is(".i-hidden")) {
                                (p + h >= c + u || ((0,
                                Gt.isRtl)() ? _ < e.offset().left + e.outerWidth() / 2 : _ > e.offset().left + e.outerWidth() / 2)) && (m = e,
                                g = !0)
                            }
                        }
                        const f = m.data("field");
                        if (m.size() && "name" !== f) {
                            ...
                            g ? (t.insertAfter(m),
                            s = t.offset().left - m[0].offsetWidth,
                            l.size() && a.size() && l.insertAfter(a)) : (t.insertBefore(m),
                            s = t.offset().left + m[0].offsetWidth,
            ...
            _fixCols() {
                ...
                const i = "big" === this._options.table_style
                  , n = window.innerWidth > Bt.breakpoints.tablet
                ...
                this._stickyWrapper) {
                    ...
                    this._stickyWrapper.style.width = function(e, t) {
                        if (!((0,
                        vi.isMarketPage)(e._model._bridge) && window.innerWidth > Bt.breakpoints.phone))
                            return;
            ...
            _updateEmptyMessageIcon() {
                ...
                const e = function() {
                    ...
                    return e || (document.querySelector("html")?.classList.contains("theme-dark") ? zi.StdTheme.Dark : zi.StdTheme.Light)
                }()
                  , t = this._$emptyMessage.find("i")
                  , o = e === zi.StdTheme.Light ? pn : hn;
                t.html(o)
            }
            _setEmptyMessage() {
                let e, t = "";
                ...
                for (let n = 0; n < e.length; n++) {
                    ...
                    for (let e = this._fieldsOrder.length - 1; e >= 0; --e) {
                        ...
                        const i = sn(this._columnsMap, t, this._model.selectedIntervalId)
                          , n = o.additionalColumns ? o.additionalColumns.map((e => Sn(r.d, sn(this._columnsMap, e, this._model.selectedIntervalId)))) : [];
                        let a = "";
                        const d = ["tv-data-table__cell"];
                        let _;
                        if (o.tooltip && ("function" == typeof o.tooltip ? a = o.tooltip(...n, o) : "string" == typeof o.tooltip && (a = o.tooltip),
                        d.push("apply-common-tooltip")),
                        "price" === o.type && n.length >= 4) {
                            const e = n.slice(-4);
                            e[2] = "true" === e[2],
                            _ = mt(...e)
                        } else
                            _ = pt(o, this._model.screener_type, !1);
                        "name" === t && n.push(r.s);
                        const m = Sn(r.d, i);
                        let g = null === m ? this._nullFormatter() : _ && _.format(m) || this._defaultFormatter({
                            value: m,
                            fieldKey: t,
                            field: o,
                            rowData: r,
                        ...
                        this._model.hasMarkedSymbols() && d.push("tv-screener-table__cell--with-marker"),
                        p > 0 && (d.push("i-hidden"),
                        p--);
                        let f = g + v + dn(s, l, o.type, g, (0,
                        vi.isMarketPage)(this._model._bridge));
                        (t === u.Name || t === u.Sector && this._model.screener_type === c.CryptoMkt) && (f = nn({
                            symbolHtml: f,
                            fieldsOrder: this._fieldsOrder,
                            rowData: r.d,
                            proSymbol: r.s
                    ...
                    _.classList.add(...a),
                    d.forEach((e => _.setAttribute(...e))),
                    _.append(h),
                    this._options.onRowBuild && this._options.onRowBuild(_, r),
                    i.appendChild(_)
                }
                ...
                case u.Sector:
                    return function(e) {
                        ...
                        if (i === c.CryptoMkt) {
                            ...
                            xo.htmlEscape)((0,
                            wn.addUtmToUrl)(o, s))}" ${l ? "" : 'target="_blank" rel="noopener"'}>\n\t\t\t\t\t\t${t}\n\t\t\t\t\t</a>`
                        }
                        if ("big" === r)
                            return Mn(t, n, o);
                        return t
        ...
        function Dn(e) {
            ...
            return o === c.ContinuousFutures ? (0,
        ...
        function In(e) {
            ...
            vi.getScreenerPage)(a)
              ...
              , v = {
                ...
                ,
                defaultFormatter: Fn(e),
                addTheadClasses: ["tv-screener-table__thead", i ? "tv-screener-table__thead--sticky" : "tv-screener-table__thead--regular"],
                addThClasses: ["tv-data-table__sortable", "tv-screener-table__sortable", "tv-screener-table__th", d ? `tv-screener-table__th--${d}` : "", "widget" === m && h ? "tv-screener-table__th--no-toolbar" : ""],
                addCellClasses: e => {
                    const {value: t, fieldKey: o, field: i} = e
                      , n = ["tv-screener-table__cell"];
                    return n.push(...function(e) {
                        const t = [];
                        e.align === Pn.Right || e.align === Pn.Center || e.control && "select" !== e.control || t.push("tv-screener-table__cell--left");
                        e.align !== Pn.Center || e.control || t.push("tv-screener-table__cell--center");
                        return t
                    }(i)),
                    i.highlightChange && t && n.push(t >= 0 ? "tv-screener-table__cell--up" : "tv-screener-table__cell--down"),
                    o !== u.Name || !g.disabled && g.checked || n.push("widget" === m ? "tv-screener-table__cell--widget-without-description" : "tv-screener-table__cell--without-description"),
                    d && n.push(`tv-screener-table__cell--${d}`),
                    "widget" === m && n.push(...function(e, t) {
                        const o = [];
                        e && o.push("tv-screener-table__cell--no-toolbar");
                        t === c.CryptoMkt && o.push("tv-screener-table__cell--crypto_mkt");
                        return o
                    }(h, l)),
                    n
                }
                ...
                onRowBuild: (t, o) => {
                    ...
                    "chart" === m && $n.linking.proSymbol.value() === o.s && i && (e._setActiveElem(t),
                    i.focusItem(t)),
            ...
            const s = new t({
                ...
                options: {
                    ...
                    onExecute: () => {
                        ...
                        (0,
                        Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ToggleDescription,"header",e))
                    }
                }
            })
              , l = new t({
                ...
                options: {
                    ...
                    onExecute: () => {
                        ...
                        i.$fieldSetsButton.toggleClass("tv-screener-toolbar__button--unsaved", i._model.isFieldSetChanged()),
                        (0,
                        Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ToggleSymbolType,"header",e))
                    }
                }
            })
              ...
              , d = new t({
                ...
                options: {
                    ...
                    onExecute: () => {
                        ...
                        i.table.update(i._data),
                        (0,
                        Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ToggleShowCurrency,"header",e))
                    }
                }
            });
            return {
                ...a ? {
                    toggleCurrencyDisplayAction: d
                } : null,
                ...
                removeColumnAction: new t({
                    ...
                    options: {
                        ...
                        onExecute: () => {
                            ...
                            i.$fieldSetsButton.toggleClass("tv-screener-toolbar__button--unsaved", i._model.isFieldSetChanged()),
                            (0,
                            Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.RemoveColumn,"header",n))
                        }
                    }
                })
            }
              ...
              , a = new t({
                ...
                options: {
                    ...
                    onExecute: () => {
                        i.resetFilter(n),
                        (0,
                        Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ResetFilter,"header",n))
                    }
                }
            })
              , d = new t({
                ...
                options: {
                    ...
                    onExecute: () => {
                        const e = Ln(l).closest("th");
                        i.showInplaceEditor(n, e),
                        s.stopPropagation(),
                        (0,
                        Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ChangeFilter,"header",n))
                    }
                }
            });
            if (r.control) {
                ...
                toggleSignalAction: new t({
                    ...
                    options: {
                        ...
                        onExecute: () => {
                            ...
                            (0,
                            Xt.sendSnowPlowData)(new Pi.DispatchContextMenuActionEvent(Bn.ToggleSignal,"header",!s))
                        }
                    }
                })
            }
        ...
        var Un = o(793242)
          , jn = o(157234);
        const zn = "screener-market-select-mode";
        var Hn = o(35387)
          , Gn = o(67905)
          , Xn = o(491540)
          , Kn = o(779893);
        ...
        class cr {
            constructor(e, t) {
                ...
                It.default)(this._changeSymbol, 500),
                this._lifecycle = new To,
                ...
                TradingView.onChartPage && Mo.subscribe("screener.selected_type_on_chart", (e => {
            ...
            _getThContent(e, t) {
                t || (t = Ze[e]);
                const i = mi(e, t) ? Kn(`<div class="tv-screener-table__head-wrap js-head-wrap apply-common-tooltip common-tooltip-fixed" title="${t.title}" data-field="${e}">`) : Kn(`<div class="tv-screener-table__head-wrap js-head-wrap" data-field="${e}">`);
                ...
                if (e === this._model.searchField) {
                    ...
                    this._onWidget || Kn(dr).appendTo(n)
                }
                let a = !1;
            ...
            _setupStickyHeader() {
                ...
                vi.isMarketPage)(this._bridge))
                    ...
                    TradingView.onChartPage && Kn(document).on("scroll", ( () => {
                        window.innerWidth <= Bt.breakpoints.tablet && (o = this.$content.get(0).getBoundingClientRect().top < 0),
            ...
            changeEarningsPeriod(e, t=!1) {
                ...
                this.updatePeriodPicker(),
                this._model.applyFieldSetContent(m);
                "tomorrow" === e || "next_week" === e ? (Ze.earnings_per_share_fq.mutateDisplayValue = () => dt,
                Ze.eps_surprise_fq.mutateDisplayValue = () => dt,
                Ze.eps_surprise_percent_fq.mutateDisplayValue = () => dt,
                Ze.revenue_fq.mutateDisplayValue = () => dt) : ht(),
            ...
            updateOldFavoritesToolbar() {
                ...
                if (this._model.favoriteFieldSets) {
                    ...
                    for (let r = 0; r < this._model.favoriteFieldSets.length; ++r) {
                        ...
                        let d = a.outerWidth();
                        a[0].scrollWidth > d && a.addClass("apply-common-tooltip").attr("title", l.title),
                        d += 9,
                        e += d,
                        e + i > t ? (e -= d,
                        a.remove(),
            ...
            initFilterHandlers(e) {
                ...
                e.off("keyup.filterInput").on("keyup.filterInput", "input:not(.js-search-input):not(.js-filter-operator-arb-value)", (i => {
                    ...
                    if (e.find(`.tv-slider[data-field="${r}"]`).slider("values", d),
                    Ze[r].value = a,
                    this._resetField(r),
                    this._model.update(),
                    Ze[r].values) {
                        const i = e.hasClass("tv-screener-dialog__filter-field") ? "filter_dialog" : "columns"
                          , n = o(Ze[r].values.length + 1, d);
            ...
            _createMultiSelectItems(e, t, o, i, n) {
                ...
                for (let s = null === o ? 0 : -1; s < r.length; ++s) {
                    ...
                    -1 === s && (o = a),
                    -1 === s && n && (l = n);
                    const d = Ze[e].rangeTitles
                      , c = d && d[l] && d[l][2]
                      , u = this._getFieldValueFromRangeTitles(l, e);
                    let h;
                    h = c && !0 === c.nowrap ? `<span class="tv-control-checkbox__label--nowrap">${u}</span>` : "country" === e ? (0,
            ...
            , s=!1, l) {
                ...
                const u = "forex-group" === o.attr("data-select-name")
                  , h = o => {
                    ...
                    s ? d && d.prop("checked", !0) : c.prop("checked", i),
                ...
                return a.resetOptions = o => {
                    t.empty(),
                    c = this._createMultiSelectItems(e, t, s ? null : c, i, l),
                ...
                t.on("change", ".js-filter-checkbox", (i => {
                    ...
                    1 === Ze[e].value.length ? Ze[e].value = Ze[e].value[0] : Ze[e].value.length || (s ? (d = r,
                    Ze[e].value = l) : Ze[e].value = null)) : s ? (d = r,
                ...
                s || t.on("click touchend", ".js-filter-checkbox-any", (i => {
                    ...
                    setTimeout(( () => {
                        if (!Ze[e].value)
                            return c.prop("checked", !0),
                            void this._closeDropdown(o);
                        c.prop("checked") ? (p.prop("checked", !0),
            ...
            _createMultiselectFilter(e, t, i, n, r=!1) {
                const s = Kn(`<div class="${n}__selectbox-container js-filter-field-${e.replace(/\W/g, "")} js-dropdown-toggle">`).appendTo(t)
                  ...
                  , d = a.find(".js-label")
                  , c = Kn('<div class="tv-dropdown__body tv-dropdown-behavior__body">');
                let u = Kn();
                if ((Ze[e].useDefaultRange ? Ze[e].defaultRange : Ze[e].range).length >= 16) {
                    const e = Kn(`<div class="${n}__search-wrap">`).appendTo(c);
                    u = Kn(`<input type="text" placeholder="${p.t(null, void 0, o(508573))}" class="${n}__search-input">`).appendTo(e);
                    const t = Kn(`<div class="tv-control-select__option-wrap ${n}__search-no-matches js-hidden">No matches</div>`).appendTo(c);
                    u.on("change input", (e => {
                        const o = u.val().trim().toLowerCase();
                        o ? _.find(".js-item-wrap").each((function() {
                            const e = Kn(this);
                            e.toggleClass("js-hidden", !~e.text().toLowerCase().indexOf(o))
                        }
                        )) : _.find(".js-item-wrap").removeClass("js-hidden"),
                        _.find(".js-item-wrap-any").toggleClass("js-hidden", !!_.find(".js-item-wrap.js-hidden").size()),
                        t.toggleClass("js-hidden", !!_.find(".js-item-wrap:not(.js-hidden)").size()),
                        s.tvDropdown("updateScroll")
                    }
                    ))
                }
                const h = Kn('<div class="tv-dropdown-behavior__scroll">').appendTo(c)
                  , _ = Kn('<div class="tv-screener-fields-popup__items-wrap tv-dropdown-behavior__inscroll">').appendTo(h)
                  , m = this._createMultiSelectItemsElement(e, _, s, n, r, ( () => {
                    d.empty(),
                    _.find(".js-filter-checkbox:checked, .js-filter-checkbox-any:checked").each(( (t, o) => {
                        d.append(Kn('<span class="tv-screener-dialog__filter-field-content-value">').text(this._getFieldValueFromRangeTitles(Kn(o).attr("name"), e)))
                    }
                    )),
                    s.focus()
                }
                  ...
                  , g = e => {
                    ...
                    this._setDropdownPosition(c, s, i),
                    c.parent().is(i)) {
                ...
                s.tvDropdown({
                    ...
                    m.changed && (m.resetOptions(!0),
                    m.changed = !1),
                    g(!0),
                    r && (_.find(".tv-control-checkbox__box, .js-filter-checkbox, .js-filter-checkbox-any").hide(),
                    this._highlightActiveItems(_),
                    _.find(".tv-control-checkbox__label").css("margin-right", 0)),
                    l.addClass(`${n}__selectbox-dropdown-toggle--open`)
                }
                )).on("afterOpenMenu", ( () => {
                    v = _.find(".js-filter-checkbox:checked"),
                    u.size() && setTimeout(( () => {
                    ...
                    s.tvDropdown("updateScroll"),
                    c.detach();
                    const t = _.find(".js-filter-checkbox:checked")
                ...
                )).on("reset", m.resetOptions).on("mousedownoutside", ( () => {
                    s.tvDropdown("close")
                }
                )),
            ...
            _applySelectbox(e, t, i={}) {
                ...
                const s = Kn(`<i class="${n}__selectbox-dropdown-toggle">`).append(Kn(o(376844)).attr({
                  ...
                  , d = Kn('<div class="tv-dropdown-behavior__scroll">').appendTo(a)
                  , c = Kn('<div class="tv-screener-fields-popup__items-wrap tv-dropdown-behavior__inscroll">').appendTo(d)
                  , u = () => {
                ...
                new Promise((t => {
                    setTimeout(( () => {
                        if ("select" === Ze[e].control)
                            ...
                            0 === r.length)
                                d = Kn(`<label class="${i}__selectbox-container js-dropdown-toggle ${i}__filter-field-content--middle js-hidden" tabindex="0">\n\t\t\t\t\t\t\t<span class="${i}__selectbox-caption-label js-label ${i}__selectbox-caption--no-value">${p.t(null, void 0, o(351514))}</span>\n\t\t\t\t\t\t</label>`).appendTo(a);
                            else {
                                for (let t = 0; t < r.length; ++t) {
                                    const o = r[t];
                                    Kn(`<option value="${o}"${o === (Ze[e].value && Ze[e].value.operator && Ze[e].value.value) ? " selected" : ""}>${Ze[o].title}</option>`).appendTo(l)
                                }
                                d = this._applySelectbox(l, n ? this._bridge.$body : this._dialog.$dialogContainer, {
                                    classPrefix: i,
                                    addClass: `${i}__filter-field-content--middle js-hidden`
                                })
                            }
                            const c = Kn(`<input type="text" name="${e}" class="${i}__filter-field-content--right ${i}__filter-field-text js-filter-operator-arb-value">`).appendTo(a);
                            Ze[e].value && "number" == typeof Ze[e].value.value && c.val(`${Ze[e].value.value}`);
                            const u = e => {
                              ...
                              , _ = Kn(`<input type="text" name="${e}" class="${i}__filter-field-content--right ${i}__filter-between-input js-filter-operator-between-left js-hidden">`).appendTo(a);
                            !Ze[e].value || "in_range" !== Ze[e].value.operator && "not_in_range" !== Ze[e].value.operator || _.val(`${-1e100 === Ze[e].value.value[0] || this._isLessThenMin(Ze[e].value.value[0], e) ? "" : Ze[e].value.value[0]}`);
                            const m = h(_)
                            ...
                            ;
                            "in_range" === t.val() || "not_in_range" === t.val() ? w(!0) : b(),
                            S(!0),
                            t.on("change", b).on("change", S).on("change", w),
                            l.on("change", S)
                        } else if ("toggle" === Ze[e].control) {
            ...
            updateIntervalButton(e=this._$selectIntervalButton, t=this._model.selectedIntervalId) {
                ...
                e.toggleClass("i-hidden", i === $t.Widget)
            }
            ...
            updateMarketButton(e) {
                ...
                if (1 === t.length) {
                    ...
                    Pt.flagUrl)(s)}" class="tv-flag-country tv-flag-country--${s}">` : o[e].icon,
                    r = o[e].title
                } else
                    i = "global",
                    r = "global",
            ...
            addMarketSelect({$before: e=null, $appendTo: t=null, $dropdownContainer: i=null, caption: r=!1, classSuffix: s=null}) {
                ...
                return this.getScreenerMarketDialogOptions = () => ({
                    ...
                    autofocus: !0,
                    initialMode: (0,
                    jn.isGlobalScreenerAvailable)() ? n.default.getValue(zn, Un.MarketDialogMode.Single) : Un.MarketDialogMode.Single,
                    defaultMarket: gi.defaultStockMarket,
                    onSelectComplete: e => {
                        var t;
                        t = e.mode,
                        n.default.setValue(zn, t);
                    ...
                    onClose: () => {
                        (0,
                        Xt.sendSnowPlowData)(new di.ChangeMarketEvent(this._model.markets.join(",")))
                    }
                }),
                l.on("click", ( () => {
                    pi(this.getScreenerMarketDialogOptions())
        ...
        function Er(e, t, o) {
            ...
            const n = function(e) {
              ...
              , {defaultCurrency: r, currencies: s} = wr({
                isGlobal: n,
                financialCurrency: e,
                symbolCurrencies: t
            });
            if (1 === s.length)
                return;
            const l = new Tr(s,r,o)
              , {selectButton: a, currencySelect: d} = l.createCurrencySelect();
            o._$currencySelectButton = a,
            o._model._currencySelect = d
        }
        var Mr = o(825957)
          , Ar = o(130969);
        const Dr = {
        ...
        var Pr = o(496499)
          , $r = o(779893);
        o(695556);
        const Ir = o(625214).linking
          , {Delegate: Br} = o(547465)
          , Lr = o(820028).WatchedValue
          , Rr = o(66974)
        ...
        const Vr = e => Ze[e] && !0 !== Ze[e].disabled && !0 !== Ze[e].hiddenColumn
          ...
          , Ur = ["pricescale", "minmov", "fractional", "minmove2"];
        var jr = o(779893);
        At.enable("widget");
        const zr = (0,
        Et.extractWidgetSettings)(window.initData.widgetDefaults)
        ...
        !function(e, t, o, i={}) {
            ...
            if (u) {
                ...
                r.ensureNotNull)(c),
                n = (0,
                r.ensureNotNull)(c.parentElement);
                ...
                c = n.querySelector(".js-embed-widget-body");
            if (i.overflowAuto && c.classList.add("tv-embed-widget-wrapper__body--overflow_auto"),
            i.showBorderOnTransparent && c.classList.add("tv-embed-widget-wrapper__body--border-on-transparent"),
            !i.isWhiteLabel) {
                !async function(e, t, o, i, n={}) {
                    const c = n.isSheriffDisabled ? [] : await (0,
                    s.getWidgetSheriffActions)()
                      , u = c.includes(d.KnownAction.LargeTradeLogo)
                      , h = function(e) {
                    ...
                    a.addUtmCampaignSource)({
                      ...
                      , m = p ?? n.copyrightOptions?.mode ?? "small_old";
                    (0,
                ...
                }(c, t, !document.documentElement.classList.contains("is-transparent") || Boolean(i.showBorderOnTransparent), o, i)
            }
            u || (e.parentElement.insertBefore(n, e),
            c.appendChild(e))
        }(Hr, "screener", (0,
        h.filterUtmInfo)(zr), {
            isWhiteLabel: zr.whitelabel,
            locale: Gr,
            overflowAuto: !0
        });
        const Xr = jr("#js-screener-container")
        ...
        zr.isTransparent && Xr.addClass("tv-widget-screener__container--transparent");
        const Yr = function(e) {
            const t = Ft((0,
          ...
          , Jr = ["morocco"]
          , Zr = [];
        if (zr.permissionOverrides?.market?.includes("uk") || Zr.push("uk"),
        zr.market) {
            const e = !Yr.includes(zr.market)
              , t = Jr.includes(zr.market)
              , o = Zr.includes(zr.market);
            (e && !t || o) && (zr.market = Yr[0])
        }
        var Qr;
        zr.screener_type || (zr.screener_type = void 0 === (Qr = zr.market) ? c.Stock : ["forex", "crypto"].includes(Qr) ? Qr : c.Stock);
        const es = zr.screener_type === c.CryptoMkt ? "cryptomktscreener" : "forexscreener"
          , ts = zr.screener_type === c.CryptoMkt ? "crypto-mkt-screener" : "screener";
        !async function(e) {
            (await (0,
            Mt.getEmbedWidgetTracker)())?.trackWidgetPageView(e)
        }(es);
        try {
            !async function(e) {
                Math.random() > .005 || (await (0,
                Mt.getEmbedWidgetTracker)())?.trackWidgetLoadMetaInfo(e)
            }({
                widget_id: ts,
                symbols: JSON.stringify([zr.market]),
                customer: zr.customer
            })
        } catch {}
        const os = {
            $body: Xr,
            ...
            onWidget: !0,
            widgetSettings: zr,
            hide_controls: !zr.showToolbar,
            marked_symbols_disabled: !0,
            table_context_menu_disabled: !1,
            open_chart_on_same_tab: !1,
            selection_disabled: !0,
            disableStickyHeader: !1,
            isUnavailableWidgetMarket: !(!zr.market || !function(e) {
                return (0,
                v.getUnavailableWidgetMarkets)().includes(e)
            }(zr.market))
        };
        (0,
        v.getUnavailableWidgetExchangesMap)()[zr.market] && (os.unavailableWidgetExchanges = (0,
        v.getUnavailableWidgetExchangesMap)()[zr.market]),
        new class {
            constructor(e) {
                if (this._bridge = e,
                this._pendingPromise = null,
                !("$body"in e) && "container"in e && (this._bridge.$body = $r(e.container)),
                ...
                this._bridge.onWidget) {
                    ...
                    this._bridge.standalone ? this.screener_type = e.screener_type || "stock" : this.screener_type = c.Crypto;
                ...
                "forex" === this.screener_type && St(["forex"]),
                ...
                this._bridge.applySymbol = (e, t=!1) => {
                    if (!0 === t || this._bridge.standalone) {
                        ...
                        Ir.setSymbolAndLogInitiator(e, "screener")
                }
                ,
                ...
                ,
                this.disabled = new Lr,
                this.fieldsOrder = new Lr,
                this._sortField = new Lr,
                this._sortDirection = new Lr,
                this.eodRestriction = new Lr($t.None),
                this._options = {},
                ...
                this.update = (0,
                It.default)(this.updateImpl.bind(this), 100),
                ...
                this.loadingStart = new Br,
                this.loadingComplete = new Br,
                this.fieldSetChanged = new Br,
                this.fieldSetSaved = new Br,
                this.filterSetChanged = new Br,
                this.filterSetSaved = new Br,
                this.filterSetDeleted = new Br,
                ...
                e.standalone && ["stock", "crypto"].includes(e.screener_type) && !e.period_picker && (i = {
                    notificationData: Dr[e.screener_type]
                },
                Promise.all([o.e(18883), o.e(46195), o.e(15371), o.e(32937), o.e(92537), o.e(79317), o.e(59235), o.e(62526), o.e(59269)]).then(o.bind(o, 515092)).then((e => e.showScreenerNewStandaloneDialog(i))))
            }
            async _initMarkedSymbols(e) {
                if (!this.hasMarkedSymbols())
                    return;
                const t = await Promise.all([o.e(27378), o.e(18883), o.e(46195), o.e(15371), o.e(32937), o.e(92537), o.e(79317), o.e(99665), o.e(20610), o.e(29002), o.e(62526), o.e(80349), o.e(10963), o.e(74339)]).then(o.bind(o, 552968))
                  , i = await Promise.all([o.e(27378), o.e(18883), o.e(46195), o.e(15371), o.e(32937), o.e(92537), o.e(79317), o.e(99665), o.e(20610), o.e(29002), o.e(62526), o.e(80349), o.e(10963), o.e(74339)]).then(o.bind(o, 811213));
            ...
            updateMetaInfo(e) {
                    ...
                    e.n in Ze) {
                        ...
                        function(e, t) {
                            ...
                            v.getMarketFieldValuesByScreenerType)(e.screener_type)
                              , i = (0,
                            v.getMarketFieldValuesByScreenerType)(c.Stock).america;
                            let n, r = [];
                        ...
                        !1 === Ze[e.n].sortable)
                            return;
                        e.t === ln.Price && (Ze[e.n].additionalColumns ? Ze[e.n].additionalColumns = Ze[e.n].additionalColumns.concat(Ur) : Ze[e.n].additionalColumns = Ur),
                ...
                Er(e.financial_currency, [...t], this._view),
                St(this.markets),
            ...
            getMetaInfo() {
                ...
                return new Promise((e => {
                    ...
                    this._pendingPromise = $r.ajax(t(e)).fail((e => {
            ...
            getScannerParams(e) {
                ...
                this.eodRestriction.value() !== $t.None && (r.options.data_restrictions = "PREV_BAR"),
            ...
            generateScanRequest() {
                ...
                e.sort = {
                    sortBy: B(this._sortField.value() || this._initialSortField, this.selectedIntervalId),
                ...
                for (let t = 0; t < e.columns.length; ++t)
                    e.columns[t] = B(e.columns[t], this.selectedIntervalId);
                ...
                return this.eodRestriction.value() !== $t.None ? e.options.data_restrictions = "PREV_BAR" : delete e.options.data_restrictions,
                e
            }
            getRequestColumns() {
                const e = [c.Stock, c.Sector, c.Industry].includes(this.screener_type) ? ["currency", "fundamental_currency_code"] : [];
            ...
            getDownloadData() {
                ...
                for (let o = 0; o < t.length; ++o) {
                    const i = t[o];
                    e.columns[o] = B(i, this.selectedIntervalId)
                }
                return new Promise((t => {
            ...
            saveSet(e, t) {
                return Promise.resolve({
                    ...
                    url: "/screener/save/",
                    data: e
                }).then($r.ajax).then((e => (e.error ? Or.logError(e.error) : t && this.trackEvent(t),
            ...
            get selectedIntervalId() {
                if (!this._bridge.hide_controls) {
                    if (this.eodRestriction.value() !== $t.None)
                        return "1D";
                    const e = this.settingsSaver.getValue(`${this.settingKey}.interval-id`, $);
                    return (this._bridge.onWidget || (0,
                    fr.enabled)(Ht.ProductFeaturesEnum.SCREENER_INTERVALS) && -1 !== (0,
                    fr.getConfig)(Ht.ProductFeaturesEnum.SCREENER_INTERVALS).interval.indexOf(e)) && I(e) ? e : $
                }
            }
            ...
            get selectedGroups() {
                return JSON.parse(this.settingsSaver.getValue(`${Nr}.screener-forex.groups`, '["Major","Minor"]')).map((e => $e[e] || e))
            }
            setSelectedGroups(e) {
                const t = Object.keys($e)
                  , o = e.map((e => t.find((t => $e[t] === e)) || e));
            ...
            get markets() {
                ...
                if (!(0,
                jn.isGlobalScreenerAvailable)() && i.length > 1)
                    return i = [e],
                    i;
            ...
            get isEntireWorld() {
                ...
                return !(!(0,
                jn.isGlobalScreenerAvailable)() && this.markets.length > 1) && e
            }
            get timezone() {
                return function(e) {
                    const t = (0,
            ...
            _updateEodRestriction() {
                ...
                this.eodRestriction.setValue(function(e) {
                    ...
                    if (i)
                        return s.every(jt.isEmbedUnrestrictedExchange) ? $t.None : $t.Widget;
                    if (n)
                        return $t.None;
                    const l = s.map(jt.getProductIdFromStockExchange);
                    return l.some((e => (0,
                    qt.isIDCExchange)(e, !0))) && (r || l.some((e => !!e && (0,
                    Ut.isUserNeedSignAgreement)(e)))) ? $t.Site : $t.None
                }(e))
            }
            ...
            backendUrl(e) {
                return (0,
                mr.getBackendUrl)(this.markets, e)
            }
            ...
            _getScanUrl(e) {
                ...
                return o && Pr[o] ? t.searchParams.append("api_key", Pr[o]) : (0,
    ...
    786284: (e, t, o) => {
        ...
        e.exports.createTvBlockWithInstance = function(e, t) {
            if (e && t)
                ...
                function(r, s, l) {
                    var a, d, c;
                    return "get" === r ? a = s : (d = s,
                    "object" == typeof r && void 0 === s ? (d = r,
                    r = "init") : "string" != typeof r && (r = "init")),
                    "getInstance" === r ? i(this).eq(0).data(e) : "destroy" === r ? (c = i(this).eq(0).data(e)) ? void ("function" == typeof c.destroy ? (o(c, "destroy", d),
                    i(this).eq(0).removeData(e)) : n.logError("[Block Plugin] " + e + " does not support destroy command")) : void console.warn("[Block Plugin] Trying to execute destroy method of " + e + " but it has not been inited") : "get" === r ? (c = i(this).eq(0).data(e)) ? "function" == typeof c[a] ? o(c, a, l) : c[a] : void console.warn("[Block Plugin] Trying to get prop or execute method of " + e + " but it has not been inited") : i(this).each((function() {
                        var s = i(this)
                          , l = s.data(e);
                        void 0 === l && (l = void 0 === d ? t(s) : t(s, d),
                        s.data(e, l)),
                        "init" !== r && ("function" == typeof l[r] ? o(l, r, d) : n.logError("[Block Plugin] " + e + " does not support command " + r))
                    }
                    ))
                }
                ;
    ...
    337793: (e, t, o) => {
        ...
        const l = o(735566).getLogger("Ui.TvControlCheckbox")
          ...
          , d = "i-inited";
        class c {
            constructor({customClass: e="tv-control-checkbox", $checkbox: t, tag: o, id: i, name: r, checked: s, disabled: a, labelLeft: c, labelRight: u, labelAddClass: h, boxAddClass: p}) {
                this.$el = null,
                void 0 === o && (o = c || u ? "span" : "label");
                const _ = t instanceof n && !!t.length;
                if (_) {
        ...
        class a {
            ...
            adaptBody() {
                ...
                const a = this._maxHeight || l
                  , d = t.top + a + 25 <= o.bottom
                  , c = o.top + 15 + a <= t.bottom;
    ...
    969680: (e, t, o) => {
        ...
        const n = () => "rtl" === window.document.dir
          ...
          , l = "‫"
          , a = "‬"
          , d = new RegExp(r + "|" + s + "|" + l + "|" + a,"g");
        function c(e) {
            return "" !== e && n() && null != e ? e.replace(d, "") : e
        }
        function u(e) {
    ...
    707934: (e, t, o) => {
        ...
        async function c(e) {
            ...
            const t = await Promise.all([o.e(14188), o.e(96426), o.e(18883), o.e(92537), o.e(19190), o.e(39759), o.e(52186), o.e(67131), o.e(59546), o.e(65161), o.e(94036), o.e(7276), o.e(51989), o.e(6796), o.e(17725), o.e(39190), o.e(82321), o.e(83215), o.e(7160), o.e(98230), o.e(5246)]).then(o.bind(o, 427013));
            await (window.pro?.ensureValidShopConf()),
            t.renderGoproDialog(e)
        }
        window.TradingView.createGoProDialog = c
    }
    ,
    958178: (e, t, o) => {
        "use strict";
        ...
        const _ = "/accounts/signup/";
        function m(e) {
            return s(_, e).then((e => e.json().then((t => {
    ...
    678708: (e, t, o) => {
        ...
        async function d(e) {
                ...
                return window.TVD.signIn(t);
            {
                ...
                const e = await Promise.all([o.e(53107), o.e(18883), o.e(98185), o.e(46195), o.e(15371), o.e(32937), o.e(92537), o.e(61171), o.e(67780), o.e(38452), o.e(78894), o.e(87833), o.e(90579), o.e(73425), o.e(65743), o.e(76052), o.e(43329), o.e(27702), o.e(59546), o.e(63585), o.e(26070), o.e(38490), o.e(87104), o.e(72297), o.e(82321), o.e(12831), o.e(85796), o.e(62526), o.e(86009), o.e(36123)]).then(o.bind(o, 455338));
    ...
    825957: (e, t, o) => {
        ...
        var i = o(383913);
        function n(e) {
            return Promise.all([o.e(25132), o.e(98185), o.e(15371), o.e(83439), o.e(92537), o.e(61681), o.e(61171), o.e(98933), o.e(67780), o.e(38452), o.e(78894), o.e(87833), o.e(90579), o.e(98158), o.e(67691), o.e(65743), o.e(50874), o.e(84587), o.e(84712), o.e(87265), o.e(98681), o.e(43329), o.e(40887), o.e(16990), o.e(89126), o.e(41392), o.e(19175), o.e(66534), o.e(71761), o.e(11194), o.e(27702), o.e(37242), o.e(11069), o.e(59546), o.e(63585), o.e(26070), o.e(38490), o.e(64175), o.e(65161), o.e(95542), o.e(91961), o.e(52165), o.e(34709), o.e(36925), o.e(82321), o.e(47793), o.e(25977), o.e(12831), o.e(24951), o.e(82043), o.e(73248), o.e(82687), o.e(14941), o.e(13831), o.e(87285), o.e(88536), o.e(57084), o.e(6884), o.e(20666), o.e(57274)]).then(o.bind(o, 975170)).then((t => i.availableOffers.runOrUpdate(( () => new t.SupportDialog(e).open()))))
        }
    }
    ,
    388130: (e, t, o) => {
    ...
    357173: (e, t, o) => {
        ...
        function l(e) {
            ...
            n.getProductForTrial)(e)).upgrade_weight : 0
        }
        function a(e) {
        ...
        function d(e) {
            ...
            i.getProPlansWithFeature)(e).filter((e => !(0,
            n.isTrialProduct)(e))))[0] || null
        }
        function c(e) {
            return function(e) {
                return e.sort(( (e, t) => a(e) - a(t)))
            }((0,
            i.getExpertPlansWithFeature)(e))[0] || null
        }
        function u(e) {
            const t = c(e)
              , o = d(e);
            return Boolean(t) && !Boolean(o)
        }
        async function h() {
            const e = await (0,
            r.fetch)("/pro-plans/profile/")
              , t = await e.json();
            if (e.ok)
                return t;
            if (403 === e.status) {
                const o = t;
                throw new s.ApiError(o.detail,e.status,o.code)
            }
    ...
    61716: (e, t, o) => {
        "use strict";
        e.exports = o.p + "astronaut.0812c6f9d094c97d892e.png"
    }
    ,
    573585: (e, t, o) => {
        "use strict";
        e.exports = o.p + "aurora.867f81e6c9f5ce89a215.png"
    }
    ,
    158841: e => {
        "use strict";
    ...
    e.O(0, [37606, 57867, 98185, 83439, 67780, 38752, 38452, 66032, 98681, 80259, 3579, 55822, 66534, 11194, 32950, 61667, 93853, 91659, 3016, 67799, 14306, 26235, 31743, 27754, 62089, 82321, 55091, 47793, 25977, 75538, 59668, 53159, 45902, 83456, 9887, 53617, 32547, 77649, 37148], ( () => {
        return t = 262307,
        e(e.s = t);
        var t
    }
