(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[25977], {
    725977: function(n, r) {
        var t;
        (function() {
            var e = this
            ...
            function O(n) {
                return function(r, t, e, u) {
                    ...
                    var i = !A(r) && g.keys(r)
                      , o = (i || r).length
                      , a = n > 0 ? 0 : o - 1;
                    return arguments.length < 3 && (e = r[i ? i[a] : a],
                    a += n),
            ...
            g.find = g.detect = function(n, r, t) {
                var e;
                if (void 0 !== (e = A(n) ? g.findIndex(n, r, t) : g.findKey(n, r, t)) && -1 !== e)
                    return n[e]
            }
            ,
            ...
            g.max = function(n, r, t) {
                var e, u, i = -1 / 0, o = -1 / 0;
                if (null == r && null != n)
                    for (var a = 0, c = (n = A(n) ? n : g.values(n)).length; a < c; a++)
                        (e = n[a]) > i && (i = e);
                else
                    r = b(r, t),
            ...
            g.shuffle = function(n) {
                for (var r, t = A(n) ? n : g.values(n), e = t.length, u = Array(e), i = 0; i < e; i++)
                    (r = g.random(0, i)) !== i && (u[i] = u[r]),
                    u[r] = t[i];
                return u
            }
            ,
            g.sample = function(n, r, t) {
                return null == r || t ? (A(n) || (n = g.values(n)),
                n[g.random(n.length - 1)]) : g.shuffle(n).slice(0, Math.max(0, r))
            }
            ,
            g.sortBy = function(n, r, t) {
                return r = b(r, t),
                g.pluck(g.map(n, (function(n, t, e) {
                    return {
                        value: n,
                        index: t,
                        criteria: r(n, t, e)
            ...
            g.first = g.head = g.take = function(n, r, t) {
                if (null != n)
                    return null == r || t ? n[0] : g.initial(n, n.length - r)
            }
            ,
            ...
            g.last = function(n, r, t) {
                if (null != n)
                    return null == r || t ? n[n.length - 1] : g.rest(n, Math.max(0, n.length - r))
            }
            ,
            ...
            g.uniq = g.unique = function(n, r, t, e) {
                ...
                for (var u = [], i = [], o = 0, a = k(n); o < a; o++) {
                    var c = n[o]
                      , f = t ? t(c, o, n) : c;
                    r ? (o && i === f || u.push(c),
                    i = f) : t ? g.contains(i, f) || (i.push(f),
                    u.push(c)) : g.contains(u, c) || u.push(c)
                }
                return u
            }
            ,
            ...
            ,
            g.unzip = function(n) {
                for (var r = n && g.max(n, k).length || 0, t = Array(r), e = 0; e < r; e++)
                    t[e] = g.pluck(n, e);
                return t
            }
            ,
            g.object = function(n, r) {
                for (var t = {}, e = 0, u = k(n); e < u; e++)
            ...
            ,
            g.indexOf = M(1, g.findIndex, g.sortedIndex),
            g.lastIndexOf = M(-1, g.findLastIndex),
            ...
            g.bind = function(n, r) {
                if (v && n.bind === v)
                    return v.apply(n, f.call(arguments, 1));
                if (!g.isFunction(n))
            ...
            g.partial = function(n) {
                var r = f.call(arguments, 1)
                  , t = function() {
                    for (var e = 0, u = r.length, i = Array(u), o = 0; o < u; o++)
                        i[o] = r[o] === g ? arguments[e++] : r[o];
            ...
            g.memoize = function(n, r) {
                var t = function(e) {
                    ...
                    return g.has(u, i) || (u[i] = n.apply(this, arguments)),
                    u[i]
                };
                return t.cache = {},
                t
            ...
            g.throttle = function(n, r, t) {
                ...
                return function() {
                    ...
                    return e = this,
                    u = arguments,
                    l <= 0 || l > r ? (o && (clearTimeout(o),
                    o = null),
                    a = f,
                    i = n.apply(e, u),
                    o || (e = u = null)) : o || !1 === t.trailing || (o = setTimeout(c, l)),
                    i
                }
            }
            ,
            g.debounce = function(n, r, t) {
                var e, u, i, o, a, c = function() {
                    var f = g.now() - o;
                    f < r && f >= 0 ? e = setTimeout(c, r - f) : (e = null,
                    t || (a = n.apply(i, u),
                    e || (i = u = null)))
                };
                return function() {
            ...
            function T(n, r) {
                var t = B.length
                  ...
                  , i = "constructor";
                for (g.has(n, i) && !g.contains(r, i) && r.push(i); t--; )
                    (i = B[t])in n && n[i] !== u[i] && !g.contains(r, i) && r.push(i)
            }
            g.keys = function(n) {
                if (!g.isObject(n))
                    return [];
            ...
            ,
            g.values = function(n) {
                for (var r = g.keys(n), t = r.length, e = Array(t), u = 0; u < t; u++)
                    e[u] = n[r[u]];
                return e
            }
            ,
            g.mapObject = function(n, r, t) {
                r = b(r, t);
                for (var e, u = g.keys(n), i = u.length, o = {}, a = 0; a < i; a++)
                    o[e = u[a]] = r(n[e], e, n);
                return o
            }
            ,
            ...
            g.pick = function(n, r, t) {
                ...
                if (null == o)
                    return i;
                g.isFunction(r) ? (u = g.allKeys(o),
                e = m(r, t)) : (u = S(arguments, !1, !1, 1),
                e = function(n, r, t) {
                    return r in t
                }
                ,
            ...
            var R = function(n, r, t, e) {
                ...
                if (!i) {
                    ...
                    var o = n.constructor
                      , a = r.constructor;
                    if (o !== a && !(g.isFunction(o) && o instanceof o && g.isFunction(a) && a instanceof a) && "constructor"in n && "constructor"in r)
                        return !1
                }
                e = e || [];
            ...
            g.template = function(n, r, t) {
                ...
                n.replace(e, (function(r, t, e, o, a) {
                    return i += n.slice(u, a).replace(P, J),
                    u = a + r.length,
            ...
            ,
            g.mixin(g),
            g.each(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], (function(n) {
                var r = i[n];
