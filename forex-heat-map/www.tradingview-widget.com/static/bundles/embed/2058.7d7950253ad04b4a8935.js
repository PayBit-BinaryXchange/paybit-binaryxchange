(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[2058, 15483, 90209], {
    429341: t => {
        t.exports = {}
    }
    ,
    ...
    190209: (t, e, s) => {
        ...
        function g(t, e, s) {
            const i = (0,
            p.toNumberOrUndefined)(t);
            if ("economic" === e?.type && 0 === i || void 0 === i)
                return;
            const o = s?.customPriceFormatter || "volume" === e.format && new c.VolumeFormatter({
                precision: 2
            }) || new l.PriceFormatter({
                priceScale: e.pricescale || 100,
                minMove: e.minmov || 1,
                fractional: e.fractional,
                minMove2: e.minmove2
            })
              , n = void 0 !== s?.signPositiveChange ? s.signPositiveChange : s?.signPositive;
            return ( (t, e=!0) => e ? `(${t})` : t)(o.format(i, {
                signPositive: n,
        ...
        var b = s(416234);
        function y(t) {
            return t === b.SymbolGroup.McxFlag
        }
        var x = s(40763);
        const N = (0,
        ...
        T.prototype._setElements = function(t) {
            this._container = t,
        ...
        ,
        T.prototype._appendAndGetNewElement = function(t, e) {
            const s = document.createElement(e);
            return t.appendChild(s),
            s
        }
        ,
        T.prototype._getFirstTextNode = function(t) {
        ...
        ,
        T.prototype.successData = function(t, e) {
            t.values && this.setState(t.values, t, e)
        }
        ,
        T.prototype.onPermissionDenied = function(t) {
            (0,
            x.isSfQuoteData)(t) || function(t) {
                return !!t && (y(t.symbolname) || "permission_denied" === t.status && y(t.values?.alternative))
            }(t) ? this._options.permissionDeniedHook ? this._options.permissionDeniedHook(t, this._symbolOriginal || this._symbol) : this.errorData(t) : this.downgradeData(t)
        }
        ,
        T.prototype.errorData = function(t) {
            ...
            this._options.noSuchSymbolHook.call(this, t, this._symbolOriginal || this._symbol)) : N.logWarn("No data for: " + this._symbol)
        }
        ,
        T.prototype.downgradeData = function(t) {
            {
        ...
        T.prototype.setState = function(t, e, i) {
            ...
            const n = this._options
              ...
              , p = this._volumeFormatter
              , f = (t, e=!0) => e ? `(${t})` : t
              , b = void 0 !== n.signPositiveChange ? n.signPositiveChange : n.signPositive
              , y = t => g(t, o, n)
              , x = t => {
                const e = a.format(t, {
                    signPositive: b,
                ...
                return f(e, n.changePercentInBrackets)
            }
              , S = r.format.bind(r)
              , C = m.format.bind(m)
              , T = p.format.bind(p)
              , w = t => null == t ? c.PLACE_HOLDER : C(t);
            n.disableChange || (this._setNodesValue(this._textNodes.change, o.change, y),
            this._setNodesValue(this._textNodes.changePercent, o.change_percent, x),
            ...
            this._setNodesValue(this._textNodes.extHrsChange, o.rch, y),
            this._setNodesValue(this._textNodes.extHrsChangePercent, o.rchp, x),
            ...
            this._setNodesValue(this._textNodes.prevClose, o.prev_close_price, S),
            ...
            if (P && (P = this._prepareSymbolDescription(P),
            this._setTextsContent(this._elements.description, P),
            this._options.addDescriptionTitle))
                for (var E = 0; E < this._elements.description.length; E++)
                    this._elements.description[E].setAttribute("title", P);
            if ((null != o.short_name || null != o.exchange) && t.short_name) {
                var F = t.short_name;
                "QUANDL" === t.exchange && void 0 !== t.short_name.split("/")[1] && (F = t.short_name.split("/")[1] + ", " + t.short_name.split("/")[0]),
                this.setShortName(F)
            }
            ...
            this._setLastValue(o.last_price, o.minmove2, S),
            this._setNodesValue(this._textNodes.extHrsClose, o.rtc, S),
            ...
            this._setNodesValue(this._textNodes.open, o.open_price, S),
            this._setNodesValue(this._textNodes.high, o.high_price, S),
            this._setNodesValue(this._textNodes.low, o.low_price, S),
            ...
            if (k && this._setNodesValue(this._textNodes.currency, k, v, !0),
            ...
            (o.rtc_time || t.rtc_time) && this._textNodes.rtcTime.length && (this._timeFormatter && this._timeFormatter.rtc ? this._setNodesValue(this._textNodes.rtcTime, f(this._timeFormatter.rtc(t.rtc_time, t.current_session), this._options.rtcTimeInBrackets)) : N.logError("rtc time field requested with no formatter provided")),
            null != o.last_price)
                for (E = 0; E < this._elements.updateMode.length; E++)
                    this._elements.updateMode[E].classList.remove("i-hidden");
        ...
        ,
        T.prototype._setNodesValue = function(t, e, s, i) {
            if (null != e || i)
                for (var o = "function" == typeof s ? s(e) : e, n = 0; n < t.length; n++)
                    t[n].nodeValue = o
        }
        ,
        T.prototype._setTextsContent = function(t, e, s) {
            if (t && t.length && e)
                for (var i = "function" == typeof s ? s(e) : e, o = 0; o < t.length; o++)
                    t[o].textContent = i
        }
        ,
        T.prototype._setLastValue = function(t, e, s) {
            if (null == t)
                return;
        ...
        ,
        T.prototype._getLastValueStringDiff = function(t, e) {
            if (t === e) {
                const [t,s] = w(e);
                return [t, "", s]
            }
            ...
            for (; t[s] === e[s]; )
                s++;
            const [i,o] = w(e.slice(s));
            return [e.slice(0, s), i, o]
        }
        ,
        T.prototype._calculatePipetteDigits = function(t) {
            return t && t !== this._lastMinMove && (this._lastMinMove = t),
            this._lastMinMove ? ("" + this._lastMinMove).length - 1 : 0
        }
        ,
        T.prototype._setChangeFontColor = function(t, e, s, i, o) {
        ...
        ,
        T.prototype._setChangeDirection = function(t, e) {
        ...
        ,
        T.prototype.setShortName = function(t="") {
            this._setTextsContent(this._elements.shortName, t)
        }
        ,
        T.prototype._prepareSymbolDescription = function(t) {
        ...
        T.prototype._initHighlighters = function() {
            this._highlighters.last = new P(this._elements.lastHighlight,this._options.growingBg,this._options.fallingBg,this._options.lastGrowingClass,this._options.lastFallingClass),
            this._highlighters.extHrsClose = new P(this._elements.extHrsClose,this._options.growingBg,this._options.fallingBg,this._options.lastGrowingClass,this._options.lastFallingClass)
        }
        ,
        ...
        ,
        T.prototype.setStateHook = function(t) {
        ...
        ,
        T.prototype._getCache = function(t) {
