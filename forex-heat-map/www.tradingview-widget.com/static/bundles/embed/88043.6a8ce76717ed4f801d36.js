(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[88043], {
    605814: (e, t, s) => {
        "use strict";
        var r;
        s.d(t, {
            ChartApiMessageMethod: () => r
        }),
        function(e) {
    ...
    800828: (e, t, s) => {
        ...
        class n {
            ...
            async getValue(e) {
                ...
                r.ensureNotNull)(t.headers.get("Content-Type")) ? t.json() : t.text()
            }
            async setValue(e, t) {
    ...
    37010: (e, t, s) => {
        ...
        var r = s(735566)
          ...
          , a = s(803912);
        const o = (0,
        r.getLogger)("ChartApi.AuthToken", {
            color: "#173"
        });
        class i {
            constructor() {
                this.invalidated = new n.Delegate,
                this._tid = 0,
                this._onOnline = () => {
                ...
                ,
                window.loginStateChange || (window.loginStateChange = new n.Delegate),
    ...
    403526: (e, t, s) => {
        ...
        function a(e) {
            for (const t of Object.keys(e)) {
                ...
                "s"in e[t] && e[t].s && !s.series && (s.series = e[t].s.map(n)),
                "st"in e[t] && e[t].st && !s.series && (s.series = e[t].st.map(n))
            }
        }
        class o {
            set_broker(e) {
            ...
            create_series(e, t, s, r, n, a, o) {
                return [e, t, s = s || "", r, n, a, o]
            }
            remove_series(e, t) {
                return [e, t]
            }
            modify_series(e, t, s, r, n, a) {
                return [e, t, s = s || "", r, n, a]
            }
            ...
            create_study(e, t, s, r, n, a) {
                return [e, t, s = s || "", r, n].concat(a)
            }
            create_child_study(e, t, s, r, n, a) {
                return this.create_study(e, t, s, r, n, a)
            }
            remove_study(e, t) {
                return [e, t]
            }
            modify_study(e, t, s, r) {
                return [e, t, s = s || ""].concat(r)
            }
            notify_study(e, t, s, r) {
                return [e, t, s = s || "", r]
            }
            create_pointset(e, t, s, r, n, a) {
                return [e, t, s = s || "", r, n].concat(a)
            }
            modify_pointset(e, t, s, r) {
                return [e, t, s = s || ""].concat(r)
            }
            remove_pointset(e, t) {
                return [e, t]
            ...
            replay_add_series(e, t, s, r) {
                return [e, t, s, r]
            }
            replay_remove_series(e, t, s, r) {
                return [e, t, s, r]
            }
            replay_set_resolution(e, t, s) {
                return [e, t, s]
            }
            replay_get_depth(e, t, s, r) {
                return [e, t, s, r]
            }
            ...
            prepareDataUpdateObjects(e, t, s) {
                for (const [n,a] of Object.entries(t)) {
                    const t = "plots"in a ? a.plots : a.series
                      , o = {
                        customId: n,
                        turnaround: a.turnaround,
                        plots: t
                    };
                    "ns"in a && a.ns && (o.nonseries = a.ns),
                    "lbs"in a && a.lbs && (o.lastBar = {
                        closeTime: a.lbs.bar_close_time
                    });
                    for (const e of o.plots)
                        for (const [t,s] of Object.entries(e.value))
                            s && Math.abs(s) >= 1e100 && (e.value[+t] = void 0);
                    s(e, n, {
                        method: r.WebchartChartSessionResponseMethod.DataUpdate,
                        params: o
                    })
                }
            }
    ...
    241361: (e, t, s) => {
        ...
        var r, n, a;
        s.d(t, {
            WebchartChartSessionResponseMethod: () => n,
            WebchartReplaySessionResponseMethod: () => a,
            WebchartResponseMethod: () => r
        }),
        function(e) {
    ...
    894645: (e, t, s) => {
        ...
        function a() {
            ...
            if (!r.enabled("widget")) {
                ...
                return (0,
                n.isTicksEnabled)() && (t = ["1T", "10T", "100T", "1000T"].concat(t)),
                t.concat(e)
            }
            return e
        }
    ...
    646244: (e, t, s) => {
        ...
        function r(e) {
            ...
            if (-1 === e.indexOf("@"))
                ...
                else if (1 === r.length && "decisionbar" === r[0])
                    t.packageId = "les-" + r[0],
                    t.id = t.shortId + "@" + t.packageId,
                    t.version = 1;
                else {
