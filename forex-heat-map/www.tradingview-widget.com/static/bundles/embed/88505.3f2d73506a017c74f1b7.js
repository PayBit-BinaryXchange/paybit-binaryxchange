(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[88505, 68984], {
    116313: t => {
        t.exports = {
    ...
    764250: (t, e, o) => {
        ...
        class n {
            constructor(t, e) {
                this._group = t;
                const {hotkey: o, handler: n, desc: i, isDisabled: r, element: s=null, isRepeatAccepted: a=!1} = e;
                this.hotkey = o,
                this.handler = n,
                this.desc = i,
                this.element = s,
        ...
        class i {
            constructor(t, e) {
                ...
                e && (this.desc = e.desc),
                e && e.isDisabled ? "function" == typeof e.isDisabled ? this.isDisabled = e.isDisabled : this.isDisabled = () => !0 : this.isDisabled = () => !1,
                this._manager.registerGroup(this)
            }
            add(t) {
                let e = this._actions.get(t.hotkey);
                e || (e = [],
                this._actions.set(t.hotkey, e));
            ...
            handleHotkey(t, e) {
                ...
                if (!o)
                    return !1;
                for (const n of o)
                    if ((!n.element || e.target && n.element.contains(e.target)) && !n.isDisabled(e))
                        return e.repeat && !n.isRepeatAccepted || (n.handler(e),
                        this._callMatchedHotkeyHandler(t)),
                        e.preventDefault(),
                        !0;
                return !1
            }
    ...
    163586: (t, e, o) => {
        ...
        class l {
            constructor() {
                this._groups = [],
                this._pressedKeys = new n.WatchedValue(0),
                this._keyboardPressedKeysState = new a(new s(0)),
                this._keyDownListener = t => {
                    if (t.defaultPrevented)
                        return;
                    const e = (0,
                    i.hashFromEvent)(t);
                    if (this._pressedKeys.setValue(e),
                    this._keyboardPressedKeysState.setValue(new s((0,
                    i.modifiersFromEvent)(t),t.code)),
                    !(0,
                    r.isNativeUIInteraction)(e, t.target))
                        for (let o = this._groups.length; o-- > 0; ) {
                            const n = this._groups[o];
                            if (!n.isDisabled()) {
                                if (n.handleHotkey(e, t))
                                    return;
                                if (n.modal)
                                    return
                            }
            ...
            promoteGroup(t) {
                ...
                for (; n < this._groups.length && c(this._groups[n], e) === o; ) {
                    ...
                    r === t ? i = 1 : c(r, e) === o && (this._groups[n - i] = r),
                    n++
                }
                this._groups[n - i] = t
            }
    ...
    471802: (t, e, o) => {
        ...
        function p(t) {
            const e = function(t) {
                ...
                return e && ((0,
                u.setTooltipData)(t, "text", e),
                t.removeAttribute("title")),
                (0,
                u.getTooltipData)(t, "text") || ""
            }(t)
        ...
        function g(t) {
            const e = (0,
            n.ensureNotNull)(L).cloneNode(!0)
              , o = T(e)
              , {content: i} = t;
            switch (i.type) {
            case "element":
                o.innerHTML = "",
                o.appendChild(i.data);
                break;
            case "html":
                o.innerHTML = i.data;
                break;
            ...
            if (t.hotkey) {
                const e = "none" !== i.type
                  , r = (0,
                n.ensureNotNull)(E).cloneNode(!0)
                  , s = (0,
                m.hotKeyDeserialize)(t.hotkey)
                ...
                }(s.text, a).replace(/\s\+\s/g, `<span class="${h["common-tooltip__plus-sign"]}">+</span>`),
                o.classList.add(h["common-tooltip__body--with-hotkey"]),
                e && r.classList.add(h["common-tooltip__hotkey-block--divider"]),
                o.appendChild(r)
            }
            return e.addEventListener("contextmenu", s.preventDefault),
            e
        }
        function f(t, e) {
            const o = e.rect;
            ...
            !function(t, e) {
                ...
                t.classList.remove(...d.map((t => c[t])).filter((t => !!t))),
                o && !t.classList.contains(o) && t.classList.add(o)
            }(t, e.colorTheme || "default"),
            e.addClass && t.classList.add(e.addClass);
            const n = T(t)
              , i = t.querySelector(`.${h["common-tooltip__button-container"]}`);
            n.classList.toggle(h["common-tooltip__body--width_wide"], Boolean(e.wide)),
            n.classList.toggle(h["common-tooltip__body--no-padding"], Boolean(e.noPadding)),
            n.classList.toggle(h["common-tooltip__body--width_narrow"], Boolean(e.narrow)),
            n.classList.toggle(h["common-tooltip__body--no-buttons"], !0),
            n.style.left = w(0),
            n.style.width = w(n.clientWidth + (Boolean(e.noPadding) ? 0 : 2));
            const s = document.body.clientWidth
              , u = l.CheckMobile.iOS() || l.CheckMobile.Android() || (0,
            l.supportTouch)() && (0,
            l.isMac)() ? window.innerHeight : document.body.clientHeight
              , m = e.vertical
              , p = e.extendMargin || m && o.w < 20 || !m && o.h < 20;
            t.classList.toggle(h["common-tooltip--farther"], p),
            t.classList.toggle(h["common-tooltip--vertical"], m),
            t.classList.toggle(h["common-tooltip--horizontal"], !m);
            const g = function(t) {
            ...
            if (m) {
                const l = 10
                  ...
                  , p = c - d
                  , y = (0,
                a.clamp)(o.y + o.h / 2, m, p) - f / 2
                  , _ = y + f;
                t.style.left = w(o.x + o.w),
                t.style.top = w(y),
                y < l ? n.style.top = i.style.top = w(l - y) : _ > c && (n.style.top = i.style.top = w(c - _));
                const {right: b} = (t.querySelector(":last-child") || n).getBoundingClientRect()
                  , v = b + 10 > s;
                t.classList.toggle(h["common-tooltip--direction_reversed"], v),
                t.classList.toggle(h["common-tooltip--direction_normal"], !v);
                let k = v ? "after" : "before";
                (0,
                r.isRtl)() ? (k = e.otr ? "after" : k,
                k = e.otl ? "before" : k) : (k = e.otr ? "before" : k,
                k = e.otl ? "after" : k),
                g.classList.toggle(h["common-tooltip__ear-holder--before"], "before" === k),
                g.classList.toggle(h["common-tooltip__ear-holder--after"], "after" === k),
                "after" === k && (t.style.left = "auto",
                t.style.right = w(s - o.x))
            } else {
                ...
                t.style.left = w(c);
                const d = l < r;
                t.classList.toggle(h["common-tooltip--direction_reversed"], d),
                t.classList.toggle(h["common-tooltip--direction_normal"], !d);
                const m = function(t, e, o, n) {
                    if (t.above)
                        return D(e, n) ? "above" : "below";
                    if (t.below)
                ...
                const {left: p} = n.getBoundingClientRect();
                let y = Math.trunc(o.x + o.w / 2 - (p + n.clientWidth / 2));
                t.style.left = w(c + y),
                t.style.width = w(n.clientWidth + i.clientWidth),
                y = d ? Math.max(0, y) : Math.min(0, y),
                i.style.left = w(-y),
                n.style.left = w(-y)
            }
        }
        ...
        const b = `\n\t<div id="common-tooltip-wrapper" class="${h["common-tooltip"]}">\n\t\t<div class="${h["common-tooltip__ear-holder"]}" >\n\t\t\t<div class="${h["common-tooltip__body"]} js-tooltip-body"></div>\n\t\t</div>\n\t\t<div class="${h["common-tooltip__button-container"]}"></div>\n\t</div>\n`
          ...
          , L = (0,
        i.parseHtmlElement)(b)
          , E = (0,
        i.parseHtmlElement)(v)
          , S = (0,
        i.parseHtmlElement)(k);
        function T(t) {
    ...
    630112: (t, e, o) => {
        ...
        function r() {
            ...
            t ? i = t : (i = document.createElement("div"),
            i.id = n,
    ...
    23580: (t, e, o) => {
        "use strict";
        function n(t, e) {
            return t && t.utm_campaign && (t.utm_campaign += `-${e}`),
            t
        }
        async function i(t, e, n, i) {
            if ("lentaru" === t) {
                const {getLentaCopyrightData: t} = await Promise.all([o.e(90431), o.e(1523)]).then(o.bind(o, 466672));
                return t()
            }
            if ("cmoneycomtw" === t) {
                const {getCmoneycomtwCopyrightData: t} = await Promise.all([o.e(47597), o.e(99578), o.e(42091)]).then(o.bind(o, 20922));
                return t(e, n)
            }
            if ("new" === i) {
                const {getTradingViewCopyrightData: t} = await Promise.all([o.e(88380), o.e(36228)]).then(o.bind(o, 703094));
                return t(e, n)
            }
            if ("with_border" === i) {
                const {getTradingViewCopyrightData: t} = await Promise.all([o.e(62764), o.e(37753)]).then(o.bind(o, 513316));
                return t(e, n)
            }
            if ("large_trade" === i) {
                const {getTradingViewCopyrightData: t} = await Promise.all([o.e(52431), o.e(47259)]).then(o.bind(o, 203515));
                return t(e, n)
            }
            {
                const {getTradingViewCopyrightData: t} = await Promise.all([o.e(47597), o.e(53259)]).then(o.bind(o, 88136));
                return t(e, n)
            }
        }
        o.d(e, {
    ...
    650401: (t, e, o) => {
        ...
        const s = window.WIDGET_SHERIFF_HOST || "https://widget-sheriff.xstaging-widget.tv"
          , a = (0,
        n.getLogger)("WidgetSheriff.Widget");
        let l = null;
        async function c() {
    ...
    175341: (t, e, o) => {
        ...
        function l(t, e, o, l={}) {
            ...
            if (u) {
                ...
                n.ensureNotNull)(d),
                c = (0,
                n.ensureNotNull)(d.parentElement);
                let t = document.querySelector(".js-embed-widget-head");
                null === t && (t = document.createElement("div"),
                t.classList.add("tv-embed-widget-wrapper__header"),
                t.classList.add("js-embed-widget-head"),
                c.insertBefore(t, d))
            } else
                c = document.createElement("div"),
                c.classList.add("tv-embed-widget-wrapper"),
                c.innerHTML = '<div class="tv-embed-widget-wrapper__header js-embed-widget-head"></div><div class="tv-embed-widget-wrapper__body js-embed-widget-body"></div>',
                d = c.querySelector(".js-embed-widget-body");
            if (l.overflowAuto && d.classList.add("tv-embed-widget-wrapper__body--overflow_auto"),
            l.showBorderOnTransparent && d.classList.add("tv-embed-widget-wrapper__body--border-on-transparent"),
            !l.isWhiteLabel) {
                !async function(t, e, o, l, c={}) {
                    const d = c.isSheriffDisabled ? [] : await (0,
                    i.getWidgetSheriffActions)()
                    ...
                    s.addUtmCampaignSource)({
                        ...l
                    }, "logo"), h)
                      , g = h ?? c.copyrightOptions?.mode ?? "small_old";
                    (0,
                    n.ensureNotNull)(t).appendChild((0,
                    r.createCopyrightLabel)({
                        sheriffOptions: d,
                        snapToEdge: o,
                        ...c.copyrightOptions,
                        ...p,
            ...
            return u || (t.parentElement.insertBefore(c, t),
            d.appendChild(t)),
            t
        }
    }
    ...
    125226: (t, e, o) => {
        ...
        const l = new class {
            enableFeature(t) {
                n.TVLocalStorage.setItem(a + t, "true"),
                s.fire(t)
            }
            disableFeature(t) {
                n.TVLocalStorage.setItem(a + t, "false"),
                s.fire(t)
            }
            resetFeature(t) {
                n.TVLocalStorage.removeItem(a + t),
                s.fire(t)
            }
        ...
        ;
        function c(t, e) {
            return (!t[e] || -1 !== t[e]) && (!!("true" === n.TVLocalStorage.getItem(a + e) || window.is_authenticated && "true" === window.user?.settings?.[a + e]) || !("false" === n.TVLocalStorage.getItem(a + e) || window.is_authenticated && "false" === window.user?.settings?.[a + e]) && (!!t[e] && (1 === t[e] || (0,
            r.shouldAffectUser)(e, t[e]))))
        }
        window.TradingView = window.TradingView || {},
        window.TradingView.FeatureToggle = l;
        const d = (u = window.featureToggleState || {},
        window.TradingView.onWidget?.() || Promise.all([o.e(80349), o.e(34604)]).then(o.bind(o, 180349)).then((t => {
            t.pushStreamMultiplexer.on("featuretoggle", (t => {
                const e = c(u, t.name);
                u[t.name] = t.state,
                e !== c(u, t.name) && s.fire(t.name)
            }
            ))
        }
        )),
    ...
    251954: (t, e, o) => {
        ...
        function l(t, e, o, r) {
            i.hasOwnProperty(t) || (i[t] = new n.Delegate),
            s[t] ? e.call(o) : i[t].subscribe(o, e, r)
        }
        function c(t, ...e) {
            const o = [t].concat(e);
            r.forEach((t => {
    ...
    799786: (t, e, o) => {
        ...
        var n = o(129592)
          ...
          , s = o(345848);
        (0,
        n.registerWindow)(window),
        i.ActionGroup.setMatchedHotkeyHandler((t => {
            (0,
            s.trackEvent)("Keyboard Shortcuts", (0,
            r.humanReadableHash)(t))
        }
        ))
    }
    ,
    588948: (t, e, o) => {
        ...
        o(650151);
        (0,
        o(735566).getLogger)("Common.InitData");
    ...
    49437: (t, e, o) => {
        ...
        r.prototype._report = function() {
            if (this.isAvailable) {
                ...
                i.logNormal(`Top ${t} keys with longest values: ${JSON.stringify(o)}`),
                i.logNormal(`Top ${t} longest key names: ${JSON.stringify(n)}`);
                try {
        ...
        r.prototype._updateLength = function() {
            if (this.isAvailable)
                ...
                for (t in this.localStorage)
                    this.localStorage.hasOwnProperty(t) && e++;
                this.length = e
            }
        }
        ,
        ...
        r.prototype.setItem = function(t, e) {
            this.isAvailable ? this.localStorage.setItem(t, e) : this.localStorage[t] = e,
            this._updateLength()
        }
        ,
        r.prototype.removeItem = function(t) {
            this.isAvailable ? this.localStorage.removeItem(t) : delete this.localStorage[t],
            this._updateLength()
        }
        ,
        ...
        t.exports.TVLocalStorage = window.TVLocalStorage
    }
    ,
    314802: (t, e, o) => {
        "use strict";
        ...
        var n = o(639247);
        function i(t, e=!1) {
            const {searchParams: o} = new URL(String(location));
            let i = "true" === o.get("mobileapp_new")
              , r = "true" === o.get("mobileapp");
            if (!e) {
                const t = n.get("tv_app") || "";
                i ||= ["android", "android_nps"].includes(t),
                r ||= "ios" === t
            }
    ...
    439563: (t, e, o) => {
        "use strict";
        async function n() {
            const t = (await Promise.all([o.e(73034), o.e(69374), o.e(36683)]).then(o.bind(o, 469449))).getTrackerInstance();
            return t || null
        }
        o.d(e, {
        ...
        function a(t) {
            try {
                const e = i()(t + function() {
                    ...
                    return r.TVLocalStorage.setItem(s, `${e}`),
                    e
                }())
                  , o = new DataView(e);
    ...
    803912: (t, e, o) => {
        ...
        function r(t, e, o={}) {
            {
                const {logOnErrorStatus: n=!0, logBodyOnError: r=!1} = o;
                e = e || {},
                function(t) {
                    return new URL(t,document.baseURI).origin === location.origin
                }(t) && (e.headers ? e.headers instanceof Headers || (e.headers = new Headers(e.headers)) : e.headers = new Headers,
                window.locale && e.headers.set("X-Language", window.locale),
                ...
                return s.then((o => {
                    if (!o.ok && n) {
                        let n = "";
                        e.method && (n += `${e.method.toUpperCase()} `),
                        n += t,
                        n += `. Status ${o.status}`,
                        o.statusText && (n += `. ${o.statusText}`),
                        o.headers.via && (n += `. Via: ${o.headers.via}`),
                        r && "string" == typeof e.body && (n += `. Body: ${e.body.slice(0, 1024)}`),
                        i.logError(n)
                    }
                    return o
                }
                ), (o => {
                    if (o && "AbortError" === o.name)
                        return;
                    let n = "";
                    e.method && (n += `${e.method.toUpperCase()} `),
                    n += t,
                    navigator.onLine ? n += `. ${o}` : n += ". User is offline.",
                    i.logError(n)
                }
                )),
                s
    ...
    760863: (t, e, o) => {
        ...
        function i(t, e) {
            const o = function(t, e) {
                let o, i;
                return o = null == e ? document.documentElement : 9 === e.nodeType ? e.documentElement : e,
                n && (i = n.get(o)),
                i || (i = o.ownerDocument.createRange(),
                i.selectNodeContents(o),
                n && n.set(o, i)),
                i.createContextualFragment(t)
            }(t, e)
              , i = o.firstElementChild;
            return null !== i && o.removeChild(i),
            i
        }
    }
    ,
    728104: (t, e, o) => {
        ...
        function n(t) {
            const e = [];
            for (const o in t)
                t.hasOwnProperty(o) && null != t[o] && e.push({
                    key: o,
    ...
    23482: (t, e, o) => {
        ...
        const n = "undefined" != typeof window && "undefined" != typeof navigator
          ...
          , m = (n && /Win32|Win64/i.test(navigator.platform),
        n && /Linux/i.test(navigator.platform),
