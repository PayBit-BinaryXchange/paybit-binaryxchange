(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[61997], {
    150335: (e, t) => {
        "use strict";
        function n(e) {
    ...
    685459: function(e, t, n) {
        ...
        !function(t) {
            ...
            s.addListener = function(e, t) {
                ...
                for (n in r)
                    r.hasOwnProperty(n) && -1 === u(r[n], t) && r[n].push(i ? t : {
                        listener: t,
                        once: !1
                    });
                return this
            ...
            s.removeListener = function(e, t) {
                ...
                for (r in i)
                    i.hasOwnProperty(r) && -1 !== (n = u(i[r], t)) && i[r].splice(n, 1);
                return this
            }
            ,
            s.off = f("removeListener"),
            ...
            ,
            s.removeAllListeners = f("removeEvent"),
