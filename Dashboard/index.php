    ...
    <nav class="navbar navbar-toggleable-md sign-in-header">
      ...
      <div class="sidebar-right pull-right">
        <ul class="navbar-nav  justify-content-end">
          ...
          <li style="margin:4px"><a href="../home.html" style="background:#3f48cc;color:white" class="btn btn-primary">Home</a></li>
          <li style="margin:4px"><a href="login.html" style="background:#3f48cc;color:white" class="btn btn-primary">Login</a></li>
          <li style="margin:4px"><a href="register.html" style="background:#3f48cc;color:white" class="btn btn-primary">Register</a></li>
        </ul>
      </div>
    </nav>
  </header>
...
<div class="col-md-8 offset-md-8 text-left side_signing_full">
  <form class="form-signin1 full_side text-white " action="" method="POST">
    ...
    <input type="text" style="color:black;font-weight:bold" name="username" class="form-control" placeholder="Username" value="" required>
    ...
    <br>
        ...
        <div class="input-group-prepend">
          <img src="img/captcha/captcha.php" alt="" srcset="">
        </div>
    ...
    <p class="mt-3"><a href="register.html" class="text-white">Register here!</a> <br>
      <a style="color:#0080db" href="forgot.html" class="">Forgot password?</a>
    </p>
  </form>
  <br>
</div>  </div>
