        ...
        class u {
            ...
            _replaceScript(r) {
                const {scriptURL: i, scriptElement: s, rawSettings: o, id: a, overrideHost: l} = r
                  , c = l || function(t) {
                    if ("BATTLE" === d) {
                        if (window.WIDGET_HOST)
                            return window.WIDGET_HOST;
                        if (t.host.match(/\.\wst\w*\.\wv$/i))
                            return `https://${(e = t.host,
                            r = 3,
                            e.split(".").slice(-r).join(".")).replace(/\.(\w)v$/i, ( (t, e) => `-widget.${e}v`))}`
                    }
                    var e, r;
                    return h
                }(i)
                ...
                this.iframeContainer = g && f ? g : document.createElement("div"),
                o && (this.settings = this.filterRawSettings(o)),
                o && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"),
                this.settings = this.filterRawSettings(this.defaultSettings));
                const w = "32px"
                  , {width: y, height: S} = this.settings
                  , b = void 0 === S ? void 0 : `${S}${Number.isInteger(S) ? "px" : ""}`
                  , v = void 0 === y ? void 0 : `${y}${Number.isInteger(y) ? "px" : ""}`;
                if (void 0 !== v && (this.iframeContainer.style.width = v),
                ...
                if (I ? ((0,
                t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I),
                s?.remove()) : f ? (this.iframeContainer.appendChild(this.iframe),
                s?.remove()) : (this.iframeContainer.appendChild(this.iframe),
                g.replaceChild(this.iframeContainer, (0,
                t.ensureNotNull)(s))),
                this.shouldListenToIframeResize && function(t, e, r) {
            ...
            _iframeSrcBase(t) {
                ...
                return this.settings.customer && -1 !== this.propertiesToSkipInHash.indexOf("customer") && (e += `${this.settings.customer}/`),
                e
            }
            _validateSettings() {
                const t = (t, e) => {
                ...
                return null !== e && null !== r && (this.settings.width = e,
            ...
            _createIframe(t, e, r, i, s) {
                ...
                return this._setSettingsQueryString(o),
            ...
            _addCSPErrorListener(t) {
                document.addEventListener("securitypolicyviolation", (e => {
                    e.blockedURI.includes(t) && (this._tryFixCSPIssueWithFallback(t),
                    console.warn("Please update your CSP rules to allow the tradingview-widget.com origin for frame-src."))
                }
                ))
            }
        ...
        new class extends u {
            ...
            widgetUtmName() {
                ...
                if (t) {
                    ...
                    if ("crypto_mkt" === t.screener_type)
                        return "cryptomktscreener";
                    if ("crypto" === t.market)
            ...
            filterRawSettings(t) {
                ...
                return void 0 !== t.transparency && (e.isTransparent = t.transparency),
