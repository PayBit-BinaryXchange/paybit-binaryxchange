        ...
        class g {
            ...
            _replaceScript(i) {
                  ...
                  , c = l || function(t) {
                    if ("BATTLE" === d) {
                        ...
                        if (t.host.match(/\.\wst\w*\.\wv$/i))
                            ...
                            i = 3,
                            e.split(".").slice(-i).join(".")).replace(/\.(\w)v$/i, ( (t, e) => `-widget.${e}v`))}`
                    }
                    var e, i;
                    return h
                }(r)
                ...
                const g = s.nonce || s.getAttribute("nonce")
                  ...
                  , p = u.querySelector(".tradingview-widget-copyright");
                this._copyrightContainer = m || p;
                const f = u.classList.contains("tradingview-widget-container");
                this.iframeContainer = u && f ? u : document.createElement("div"),
                ...
                u.replaceChild(this.iframeContainer, (0,
                t.ensureNotNull)(s))),
            ...
            filterRawSettings(t) {
                ...
                try {
                    ...
                    e.height = function(t, e, i, r) {
                        let s = (n = t === p.Adaptive && r ? r <= y : t === p.Compact,
                        n ? 72 : 44);
                        var n;
                        return e || (s += 2),
                        i && (s += 32),
