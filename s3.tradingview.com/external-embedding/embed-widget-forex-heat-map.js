( () => {
    ...
    ( () => {
        ...
        new class extends u {
            get widgetId() {
                return "forex-heat-map"
            }
            get useParamsForConnectSocket() {
                return !0
            }
            get propertiesToWorkWith() {
                return ["colorTheme", "currencies", "customer", "disableCrossClickHref", "frameElementId", "height", "isTransparent", "largeChartUrl", "locale", "width", "backgroundColor"]
            }
        }
    }
    )()
