(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[53259], {
    754901: t => {
        t.exports = {
            "css-value-copyright-transition-params-half-time": ".3s 0s cubic-bezier(.4, .01, .22, 1)",
            label: "label-e9c6dycV",
            logoWrap: "logoWrap-e9c6dycV",
            svgTextWrap: "svgTextWrap-e9c6dycV",
            large: "large-e9c6dycV"
        }
    }
    ,
    88136: (t, e, i) => {
        ...
        function s(t, e) {
            return {
                ...
                theme: r,
                url: (0,
                c.getLocalizedTvHostWithUtm)(t, e)
            }
        }
    }
    ,
    427072: (t, e, i) => {
        "use strict";
        i.d(e, {
            getLocalizedTvHostWithUtm: () => a
        });
        var c = i(133887)
          , r = i(283834);
        function a(t, e) {
            const i = (0,
            c.getTVHostFromLocale)(t || "en")
              , a = e ? (0,
            r.buildUtmQueryString)(e) : "";
            return `https://${i}${a ? "?" + a : ""}`
        }
    }
    ,
    852669: (t, e, i) => {
        "use strict";
        i.d(e, {
            getLocalizedDomain: () => r,
            getLocalizedDomainUrl: () => a
        });
        const c = {
            ar_AE: "ar",
            de_DE: "de",
        ...
        function a(t, e) {
            const i = r(e)
              , c = t.toString()
              , a = t.pathname
              , h = /^https:\/\/([\w-]+)\.xstaging(-widget)?\.tv/;
            return /^https:\/\/((\w*-)?(beta|beta0))\.tradingview\.com/.test(c) ? "www" === i ? `https://beta.tradingview.com${a}` : `https://${i}-beta.tradingview.com${a}` : h.test(c) ? c.replace(h, "https://$1.xstaging.tv") : /\/localhost/.test(c) ? c : /^https:\/\/(\w+\.)?tradingview\.com/.test(c) ? `https://${i}.tradingview.com${a}` : c
        }
    }
    ,
    133887: (t, e, i) => {
        "use strict";
        i.d(e, {
            getTVHostFromLocale: () => r
        });
        var c = i(852669);
        function r(t) {
            return (0,
            c.getLocalizedDomain)(t) + ".tradingview.com"
        }
    }
    ,
    304499: t => {
        t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 10" width="17" height="10" fill="none"><path fill="#131722" fill-rule="evenodd" clip-rule="evenodd" d="M13.42 9.04H9.47l3.56-9h3.94l-3.55 9ZM7 .04H0v3h4v6h3v-9Zm2.5 3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/></svg>'
    }
    ,
    85792: t => {
